...
$AboutData=mysql_fetch_assoc(mysql_query("select * from tbl_aboutUS"));
...
<title itemprop="description"><?php echo stripslashes(ucwords($AboutData['content_TitleMeta'])); ?>  | About Us </title>
...
<div class="login">
  ...
  <h2 style="margin-bottom:10px;color:#E51B24;"><font><font>About Us
