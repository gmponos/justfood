...
$ProductServiceInter=array("restaurant_id"=>$_POST['restaurant_id'],"restaurant_name"=>mysql_real_escape_string($resdata['restaurant_name']),"EventName"=>mysql_real_escape_string($_POST['EventName']),"EventEmail"=>$_POST['EventEmail'],"EventContactNo"=>$_POST['EventContactNo'],"EventMessage"=>mysql_real_escape_string($_POST['EventMessage']),"ip"=>$_SERVER['REMOTE_ADDR'],"created_date"=>date('d l Y'));
$CuisineInsert=$dbObj->dataInsert($ProductServiceInter,"tbl_restaurantEventOnline");
if($CuisineInsert)
{
$subject ='Thankyou for Event Booking With '.$resdata['restaurant_name'];
$to=$_POST['EventEmail'].','.$resdata['restaurant_FeedbackEmail'].','.$resdata['restaurant_contact_email'].','.$RegistrationDataLoginVal['contactusemail'];
$from=$_POST['EventEmail'];
              ...
              <td rowspan='2'> 
                ...
                <table cellpadding='0' cellspacing='0' width='730'>
                  <tbody>
                   ...
                   <tr>
                          <td > 
<h2 style='color:#000066;margin-left:10px; margin-top:10px;'>Hi ".ucwords($_POST['EventName'])." !</h2>
<p style='padding:10px 0 0 20px;margin-left:20px;margin-bottom:1em;font-family:Arial,Helvetica,sans-serif;font-size:17px;color:#3a3a3a'>
                          Thankyou for Event Booking with ".$resdata['restaurant_name']." </p>
...
<table width='100%' align='center' style='padding:10px;'>
  <tr>
    ...
    <td>:</td>
    <td>".$_POST['EventContactNo']."</td>
  </tr>
  
  <tr>
    <td><strong>Message </strong></td>
    <td>:</td>
    <td>".$_POST['EventMessage']."</td>
  </tr>
