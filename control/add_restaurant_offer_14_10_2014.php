...
xmlhttp.send();
    ...
    <td>	<select  data-placeholder="Select Restaurant..." required onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);"  id="restaurant_state" name="restaurant_state" onchange="getOrgTypeListRestCityOffer(this.value)" style="width:317px;" >
  ...
  <select data-placeholder="Select Restaurant..." multiple="multiple"  id="OrderDiscountmenuCategory" name="OrderDiscountmenuCategory[]" style="width:317px;" >
    <option value="">Select</option>
       <?php 
											 if($CuisineData['restaurant_id']!=''){
											  $StateQuery = $dbb->showtabledata("tbl_restMenuCategory","restaurantMenuID",$CuisineData['restaurant_id']);
											  }
