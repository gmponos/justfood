...
{
 $CuisineQuery = $dbb->showtabledata("tbl_restalcoholTime24","restaurantID",$_GET['restaurant_id']);
...
$restaurant_alcohol_sun_selected=$_POST['restaurant_alcohol_sun_selected'];
}
else
{
...
$restaurant_alcohol_mon_selected=$_POST['restaurant_alcohol_mon_selected'];
}
else
{
...
$restaurant_alcohol_tue_selected=$_POST['restaurant_alcohol_tue_selected'];
}
else
{
...
$restaurant_alcohol_wed_selected=$_POST['restaurant_alcohol_wed_selected'];
}
else
{
...
$restaurant_alcohol_thu_selected=$_POST['restaurant_alcohol_thu_selected'];
}
else
{
...
$restaurant_alcohol_fri_selected=$_POST['restaurant_alcohol_fri_selected'];
}
else
{
...
$restaurant_alcohol_sat_selected=$_POST['restaurant_alcohol_sat_selected'];
}
else
{
...
$data = array(
	...
	'restaurant_alcohol_sun_selected' => $restaurant_alcohol_sun_selected,
	'restaurant_alcohol_mon_selected' => $restaurant_alcohol_mon_selected,
	'restaurant_alcohol_tue_selected' => $restaurant_alcohol_tue_selected,
	'restaurant_alcohol_wed_selected' => $restaurant_alcohol_wed_selected,
	'restaurant_alcohol_thu_selected' => $restaurant_alcohol_thu_selected,	
	'restaurant_alcohol_fri_selected' => $restaurant_alcohol_fri_selected,
	'restaurant_alcohol_sat_selected' => $restaurant_alcohol_sat_selected,
	'restaurantID' => $_GET['restaurant_id'],
	);
	$resultDataTime = $m->update('tbl_restalcoholTime24',$data,'restaurantID='.$_GET['restaurant_id']);
$emsg=1;
}
 ?>	
...
<div id="page-wrap">
				...
				<div class="container-fluid">
					<div class="tabbable main-tabs">
						<ul class="nav nav-tabs">
							<li class="active" style="background-color:#f2f2f2;"><a href="#mainFormElements" style="background-color:#f2f2f2;" data-toggle="tab"><i class="icon-file"></i>Restaurant alcohol Time Table</a></li>
						</ul>
									...
									<div class="well">
										<div class="navbar">
											<div class="navbar-inner">
												<a class="brand" href="#">Restaurant alcohol Time Table</a>
											</div>
										</div>
                                        ...
                                        <div class="row-fluid">
                                         <?php
											...
											<div id="display-success">
			                                 <img src="img/correct.png" alt="Success" />Restaurant alcohol has been successfully updated.
		                                     </div>
											<?php }?>
                                           <form  method="post">
  ...
  <tr>
    <td height="35"><label for="restaurant_social_media"><input type="checkbox" name="restaurant_alcohol_sun_selected" id="restaurant_alcohol_sun_selected"  <?php if($data['restaurant_alcohol_sun_selected']!=''){ ?> checked="checked" <?php } ?>  value="Sunday" />Sunday</label></td>
    <td> 
...
<option value="0:00:00" <?php if($data['SundayBusinessHoursCloseTime']=="00:00:00"){ ?> selected="selected" <?php } ?>>0:00:00</option>
    ...
    <!--<input  value="" type="text" name="SundayBusinessHours" placeholder="Sunday Business Hours" style="width:330px;" required>--></td>
     <td><label for="restaurant_social_media"><input type="checkbox" name="restaurant_alcohol_mon_selected" id="restaurant_alcohol_mon_selected"  <?php if($data['restaurant_alcohol_mon_selected']!=''){ ?> checked="checked" <?php } ?>  value="Monday" />Monday</label></td>
    <td> 
...
<option value="0:00:00" <?php if($data['MondayBusinessHoursCloseTime']=="00:00:00"){ ?> selected="selected" <?php } ?>>0:00:00</option>
  ...
  <tr>
    <td height="33"><label for="restaurant_social_media"><input type="checkbox" name="restaurant_alcohol_tue_selected" id="restaurant_alcohol_tue_selected"  <?php if($data['restaurant_alcohol_tue_selected']!=''){ ?> checked="checked" <?php } ?>  value="Tuesday" />Tuesday</label></td>
    <td> 
...
<option value="0:00:00" <?php if($data['TuesdayBusinessHoursCloseTime']=="00:00:00"){ ?> selected="selected" <?php } ?>>0:00:00</option>
    ...
    <input type="checkbox" name="TuesdayBusinessHoursClose" id="TuesdayBusinessHoursClose" onClick="changeStatus2()" value="Close">&nbsp;&nbsp;Close
     ...
     <td><label for="restaurant_social_media"><input type="checkbox" name="restaurant_alcohol_wed_selected" id="restaurant_alcohol_wed_selected"  <?php if($data['restaurant_alcohol_wed_selected']!=''){ ?> checked="checked" <?php } ?>  value="Wednesday" />Wednesday</label></td>
    <td> 
...
<option value="0:00:00" <?php if($data['WednesdayBusinessHoursCloseTime']=="00:00:00"){ ?> selected="selected" <?php } ?>>0:00:00</option>
   ...
   <tr>
    <td height="30"><label for="restaurant_social_media"><input type="checkbox" name="restaurant_alcohol_thu_selected" id="restaurant_alcohol_thu_selected"  <?php if($data['restaurant_alcohol_thu_selected']!=''){ ?> checked="checked" <?php } ?>  value="Thursday" />Thursday</label></td>
    <td> 
...
<option value="0:00:00" <?php if($data['ThursdayBusinessHoursCloseTime']=="00:00:00"){ ?> selected="selected" <?php } ?>>0:00:00</option>
    ...
    <input type="checkbox" name="ThursdayBusinessHoursClose" id="ThursdayBusinessHoursClose" onClick="changeStatus4()"  value="Close">&nbsp;&nbsp;Close
     ...
     <td><label for="restaurant_social_media"><input type="checkbox" name="restaurant_alcohol_fri_selected" id="restaurant_alcohol_fri_selected"  <?php if($data['restaurant_alcohol_fri_selected']!=''){ ?> checked="checked" <?php } ?>  value="Friday" />Friday</label></td>
    <td> 
...
<option value="0:00:00" <?php if($data['FridayBusinessHoursCloseTime']=="00:00:00"){ ?> selected="selected" <?php } ?>>0:00:00</option>
    ...
    <tr>
    <td><label for="restaurant_social_media"><input type="checkbox" name="restaurant_alcohol_sat_selected" id="restaurant_alcohol_sat_selected"  <?php if($data['restaurant_alcohol_sat_selected']!=''){ ?> checked="checked" <?php } ?>  value="Saturday" /> Saturday</label></td>
    <td> 
