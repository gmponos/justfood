...
?>
	...
	<div class='block'>
		...
		<div><img src='<?php echo resize('images/theme-restaurant-banner.jpg',$settings)?>' border='0' /></div>
		<p>Image cropped &amp; resized by width and height from a remote location.</p>
		<div><pre><code>src: http://phpexpertgroup.com/munch/html/images/theme-restaurant-banner.jpg<?php echo "\n\n"; print_r($settings)?></code></pre></div>
	</div>
