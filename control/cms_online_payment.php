...
mysql_query ("set character_set_results='utf8'"); 
 $CuisineQuery = $dbb->showtabledata("tbl_securePayment","id",1);
				...
				<div class="container-fluid">
					<div class="tabbable main-tabs">
						<ul class="nav nav-tabs">
							<li class="active" style="background-color:#f2f2f2;"><a href="#mainFormElements" style="background-color:#f2f2f2;" data-toggle="tab"><i class="icon-file"></i>Secure Online Payment</a></li>
						</ul>
									...
									<div class="well">
										<div class="navbar">
											<div class="navbar-inner">
												<a class="brand" href="#">Secure Online Payment</a>
											</div>
										</div>
                                         <?php
											if($_GET['emsg']!='')
											...
											<div id="display-success">
			                                 <img src="img/correct.png" alt="Success" />Secure Online Payment has been successfully updated.
		                                     </div>
											<?php }?>
										<div class="row-fluid" >
											<div  class=" span12">
												<form id="SignupForm" action="InsertPhp.php?tag=SecurePaymentEdit&eid=1" method="post">
...
<input type="submit" class="btn btn-inverse" name="addEditContent"  value="Update Secure Online Payment" >
</td></tr>
