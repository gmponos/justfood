         ...
         <tr>
          ...
          <td width="380"><select multiple    data-placeholder="Select Restaurant Name..." id="RestaurantMenuItem" onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);" name="RestaurantMenuItem[]" style="width:317px; height:100px;">
              ...
              <?php 
											if($_GET['RestaurantCategoryID']!='')
											{
											   $StateQuery =mysql_query("select * from tbl_restaurantMainMenuItem where RestaurantCategoryID='".$_GET['RestaurantCategoryID']."' and offeravailable='1' ");
											 }
											 else
											 {
											 $StateQuery =mysql_query("select * from tbl_restaurantMainMenuItem where offeravailable='1' group by  RestaurantPizzaItemName");
											 }
                                              while($StateData=mysql_fetch_assoc($StateQuery)){
											  ?>
