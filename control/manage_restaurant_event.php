...
<div id="page-wrap">
    ...
    <div class="span12">
		...
		$url="manage_restaurant_event.php?restaurant_id=".$_GET['restaurant_id']."&statusid=".$_GET['statusid']."&";
		$where="RestaurantEventID='".$_GET['restaurant_id']."' and status='".$_GET['statusid']."'";
		$qur="SELECT * FROM {$statement} where RestaurantEventID='".$_GET['restaurant_id']."' and status='".$_GET['statusid']."'  $sortBy LIMIT {$startpoint} , {$limit}";
		}
		elseif($_GET['RestaurantEventID']!='')
		{
		$url="manage_restaurant_event.php?restaurant_id=".$_GET['restaurant_id']."&";
		$where="RestaurantEventID='".$_GET['restaurant_id']."'";
		
		$qur="SELECT * FROM {$statement} where RestaurantEventID='".$_GET['restaurant_id']."' $sortBy LIMIT {$startpoint} , {$limit}";
		}
...
xmlhttp.send();
                                        ...
                                        <form action="manage_restaurant_event.php" method="get" id="userform" name="userform">
                                          ...
                                          <tr  id="alldispaly" style="display:none;">
                                                ...
                                                <th><input type="checkbox" id="check_all" value=""></th>
													...
													$imgSort='<img src="sortasc.png" style="float:right;" />';
													 ...
													 ?>
                                                      <a onclick="submitURL('RestaurantEventID','<?php echo $pl;?>','<?php echo $_GET['restaurant_id'];?>','<?php echo $_GET['statusid'];?>');" style="cursor:pointer;">Restaurant  
                                                     <?php echo $imgSort;?>
                                                   </a></th>
                                                    <th>  <a onclick="submitURL('RestaurantEventName','<?php echo $pl;?>','<?php echo $_GET['restaurant_id'];?>','<?php echo $_GET['statusid'];?>');" style="cursor:pointer;">Event Name  
                                                     <?php echo $imgSort;?>
                                                   </a></th>
                                                   
													<th>  <a onclick="submitURL('RestaurantEventStartDate','<?php echo $pl;?>','<?php echo $_GET['restaurant_id'];?>','<?php echo $_GET['statusid'];?>');" style="cursor:pointer;">Event Start  
                                                     <?php echo $imgSort;?>
                                                   </a></th>
                                                    <th>  <a onclick="submitURL('RestaurantEventEndDate','<?php echo $pl;?>','<?php echo $_GET['restaurant_id'];?>','<?php echo $_GET['statusid'];?>');" style="cursor:pointer;">Event End  
                                                     <?php echo $imgSort;?>
                                                   </a></th>
