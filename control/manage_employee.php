				...
				<div class="container-fluid">
					<div class="tabbable main-tabs">
						<ul class="nav nav-tabs">
							<li class="active" style="background-color:#f2f2f2;"><a href="#mainFormElements" style="background-color:#f2f2f2;" data-toggle="tab"><i class="icon-file"></i>Manage Employee</a></li>
						</ul>
									...
									<div class="well">
										<div class="navbar">
											<div class="navbar-inner">
												<a class="brand" href="#">Manage Employee</a>
											</div>
										</div>
                                         <div>  
										<?php if($_GET['msg']==1)
											...
											<div id="display-success">
			                                 <img src="img/correct.png" alt="Success" /> New Manage Employee has been successfully saved
		                                     </div>
											<?php } if($_GET['error']==1){?>
											<div id="display-error">
			                                 <img src="img/error.png" alt="Error" />New Manage Employee is already exit.
		                                     </div>
                                            <?php } ?>
										<?php
											if($_GET['dmsg']!='')
											{?>
											<div id="display-success">
			                                 <img src="img/correct.png" alt="Success" />Manage Employee has been successfully deleted.
		                                     </div>
											<?php }?>
											...
											{?>
											<div id="display-success">
			                                 <img src="img/correct.png" alt="Success" />Manage Employee has been successfully actiavted/Deactivated.
		                                     </div>
											<?php }?></div>
										<div class="row-fluid">
    <div class="span12">
     <?php
		...
		$url="manage_employee.php?restaurant_id=".$_GET['restaurant_id']."&ipblock=".$_GET['ipstatus']."&statusid=".$_GET['statusid']."&";
		$where="ResEmployeeID='".$_GET['restaurant_id']."' and ipblock='".$_GET['ipstatus']."' and status='".$_GET['statusid']."'";
		...
		$url="manage_employee.php?restaurant_id=".$_GET['restaurant_id']."&statusid=".$_GET['statusid']."&";
		...
		$url="manage_employee.php?restaurant_id=".$_GET['restaurant_id']."&ipstatus=".$_GET['ipstatus']."&";
		...
		$url="manage_employee.php?restaurant_id=".$_GET['restaurant_id']."&";
		$where="ResEmployeeID='".$_GET['ResEmployeeID']."'";
		...
		$url="manage_employee.php?statusid=".$_GET['statusid']."&";
		...
		$url="manage_employee.php?ipstatus=".$_GET['ipstatus']."&";
		...
		{
		$url="manage_employee.php?ResEmp=1&";
		$where="ResEmployeeID=''";
...
{
window.location.href="manage_employee.php?ResEmployeeID="+restaurantState1+"&ipstatus="+restaurantCity1+"&statusid"+statusid1+"&sort="+str+"&f="+Dvalue
}
...
xmlhttp.send();
    ...
    <form action="manage_employee.php" method="get" id="userform" name="userform">
  ...
  <tr>
    ...
    <td> <select  class="chzn_a span8"  name="statusid" style="width:70px;" id="statusid" onChange="document.userform.submit();" >
...
<option value="1" <?php if($_GET['statusid']==1){ ?> selected="selected" <?php } ?> >Deactivated</option>
    ...
    <td> <select  class="chzn_a span8"  name="ipstatus" style="width:70px;" id="ipstatus" onChange="document.userform.submit();" >
		  ...
		  <form name="frmproduct" method="post">
				...
				<?php if($numrowdata>0){ ?>
                                              <tr  id="alldispaly" style="display:none;">
													<td colspan="6" align="right" style="margin-left:200px;"><input name="deleteall" id="deleteall" class="btn btn-warning" title="Delete All Employee" value="Delete All" onClick="return confirm('Are you sure to delete selected employee');"  type="submit">&nbsp;<input name="activateall" id="activateall" class="btn btn-warning" title="Activate All Employee" value="Activate All" onClick="return confirm('Are you sure to activate selected employee');"  type="submit">&nbsp;<input name="dactivateall" id="dactivateall" class="btn btn-warning" title="Deactivate All Employee" value="Deactivate All" onClick="return confirm('Are you sure to deactivate selected employee');"  type="submit"></td></tr>
                                                    <?php } ?>
												<tr>
