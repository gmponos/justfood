...
mysql_query ("set character_set_results='utf8'"); 
 $CuisineQuery = $dbb->showtabledata("tbl_Terms","id",1);
				...
				<div class="container-fluid">
					<div class="tabbable main-tabs">
						<ul class="nav nav-tabs">
							<li class="active" style="background-color:#f2f2f2;"><a href="#mainFormElements" style="background-color:#f2f2f2;" data-toggle="tab"><i class="icon-file"></i>Terms & Condition</a></li>
						</ul>
									...
									<div class="well">
										<div class="navbar">
											<div class="navbar-inner">
												<a class="brand" href="#">Terms & Condition</a>
											</div>
										</div>
                                         <?php
											if($_GET['emsg']!='')
											...
											<div id="display-success">
			                                 <img src="img/correct.png" alt="Success" />Terms & Conditions has been successfully updated.
		                                     </div>
											<?php }?>
										<div class="row-fluid" >
											<div  class=" span12">
												<form id="SignupForm" action="InsertPhp.php?tag=TermsEdit&eid=1" method="post">
...
<input type="submit" class="btn btn-inverse" name="addEditContent"  value="Update Terms & Conditions" >
</td></tr>
