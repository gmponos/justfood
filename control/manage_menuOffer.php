...
xmlhttp.send();
                                             ...
                                             <form action="manage_menuOffer.php" method="get" id="userform" name="userform">
  ...
  <td><label for="restaurant_id">By State</label></td>
    ...
    <td>	<select data-placeholder="Select Restaurant..." onChange="getOrgTypeListRestOffer(this.value)"  id="restaurant_city1" name="restaurant_city" style="width:180px;" >
    <option value="">Select</option>
											  <?php 
    ...
    <td><label for="restaurantMenuID">By Restaurant </label></td>
    <td>	<select  data-placeholder="Select Restaurant..." onChange="document.userform.submit();"  id="RestaurantPizzaID22" name="RestaurantPizzaID" style="width:180px;" >
...
<option value="1" <?php if($_GET['statusid']==1){ ?> selected="selected" <?php } ?> >Deactivated</option>
        ...
        ?>
					...
					<!--	<a href="#" class="sepV_a" title="View"><i class="icon-eye-open"></i></a>-->
						<a href="InsertPhp.php?tag=ResMenuOfferCategoryDelete&eid=<?php echo $row['id'];?>" onClick="return confirm('Are you sure to do this action.');" class="btn btn-dualima" title="Delete Menu Offer Name">Delete</a>
