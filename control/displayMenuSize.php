...
return ((k > 64 && k < 91) || (k > 96 && k < 123) || (k == 8) || (k == 32));
    ...
    <form id="SignupForm"  method="post" enctype="multipart/form-data">
      <table  align="center" border="0">
        <tr>
          <td><label for="OptionOneTitle">Food Item <span style="color:#FF0000;">*</span></label></td>
        ...
        <tr>
          <td><label for="SizeMenuName">Food Size Name <span style="color:#FF0000;">*</span></label></td>
        ...
        <tr>
         <td><label for="SizeMenuPrice">Food Size Price <span style="color:#FF0000;">*</span></label></td>
        ...
        <?php if($_GET['eid']!=''){ ?>
        <tr>
         <td><label for="sizePosition">Food Size Position <span style="color:#FF0000;">*</span></label></td>
          <td><input  name="sizePosition" required onkeypress='return isNumberKey(event);' onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);" id="sizePosition" value="<?php echo $CuisineData['sizePosition'];?>"  type="text"   style="width:300px;"/></td>
        </tr>
