				...
				<div class="container-fluid">
					<div class="tabbable main-tabs">
						<ul class="nav nav-tabs">
							<li class="active" style="background-color:#f2f2f2;"><a href="#mainFormElements" style="background-color:#f2f2f2;" data-toggle="tab"><i class="icon-file"></i>Monthly Restaurant Orders</a></li>
						</ul>
									...
									<div class="well">
										<div class="navbar">
											<div class="navbar-inner">
												<a class="brand" href="#">Monthly Restaurant Orders</a>
											</div>
										</div>
										<div class="row-fluid">
            <div class="span12">
...
$Monthlyordertotal=mysql_num_rows(mysql_query("select * from resto_order where odr_date<=CURDATE() AND odr_date>=$wKdat $resdID "));
$Monthlyorderaccept=mysql_num_rows(mysql_query("select * from resto_order where status='1' and odr_date<=CURDATE() AND odr_date>=$wKdat $resdID"));
$Monthlyordertransit=mysql_num_rows(mysql_query("select * from resto_order where status='2' and odr_date<=CURDATE() AND odr_date>=$wKdat $resdID"));
$Monthlyorderdelivery=mysql_num_rows(mysql_query("select * from resto_order where status='3' and odr_date<=CURDATE() AND odr_date>=$wKdat $resdID"));
$Monthlyordercomplete=mysql_num_rows(mysql_query("select * from resto_order where status='4' and odr_date<=CURDATE() AND odr_date>=$wKdat $resdID"));
$Monthlyordercancel=mysql_num_rows(mysql_query("select * from resto_order where status='5' and odr_date<=CURDATE() AND odr_date>=$wKdat $resdID"));


					?>
                <table width="100%" border="0">
  <tr>
   <td> <span class="label label-success pull-right sl_status" style="height:24px; line-height:24px;"><strong style="">Total Orders (<?php echo $Monthlyordertotal; ?>)</strong></span> </td>
    <td> <span class="label label-success pull-right sl_status" style="height:24px; line-height:24px;"><strong style="">Total <?php echo ucwords($adata['status']); ?> Orders (<?php echo $Monthlyorderaccept; ?>)</strong></span> </td>
    <td> <span class="label label-important pull-right sl_status" style="height:24px; line-height:24px;"><strong>Total <?php echo ucwords($trdata1['status']); ?> Orders (<?php echo $Monthlyordertransit; ?>)</strong></span></td>
    <td> <span class="label label-warning pull-right sl_status" style="height:24px; line-height:24px;"><strong>Total <?php echo ucwords($dvdata2['status']); ?> Orders (<?php echo $Monthlyorderdelivery; ?>)</strong></span></td>
    <td> <span class="label label-info pull-right sl_status" style="height:24px; line-height:24px;"><strong>Total <?php echo ucwords($cpdata3['status']); ?> Orders (<?php echo $Monthlyordercomplete; ?>)</strong></span></td>
    <td> <span class="label label-inverse pull-right sl_status" style="height:24px; line-height:24px;"><strong>Total <?php echo ucwords($candata4['status']); ?> Orders (<?php echo $Monthlyordercancel; ?>)</strong></span></td>
  </tr>
</table>
<br /><br />
...
<form action="Monthly_restaurantOrder.php" method="get" name="userform" id="userform">
<table width="100%" border="0" style="padding:15px;">
  <tr>
    ...
    <option value="">Select Restaurant</option>
				...
				<div class="tabbable">
					<ul class="nav nav-tabs">
						<li style="background:#009500; " ><a href="#tab1" data-toggle="tab" style="color:#FFFFFF; font-size:18px;"><?php echo ucwords($adata['status']); ?> Orders(<?php echo $Monthlyorderaccept; ?>)</a></li>
						<li style="background:#009500; "><a href="#tab2" data-toggle="tab" style="color:#FFFFFF; font-size:18px;"><?php echo ucwords($trdata1['status']); ?> Orders( <?php echo $Monthlyordertransit; ?>)</a></li>
						<li style="background:#009500; "><a href="#tab3" data-toggle="tab" style="color:#FFFFFF; font-size:18px;"><?php echo ucwords($dvdata2['status']); ?> Orders(<?php echo $Monthlyorderdelivery; ?>)</a></li>
                        	<li style="background:#009500; "><a href="#tab4" data-toggle="tab" style="color:#FFFFFF; font-size:18px;"><?php echo ucwords($cpdata3['status']); ?> Orders(<?php echo $Monthlyordercomplete; ?>)</a></li>
                            <li style="background:#009500; "><a href="#tab5" data-toggle="tab" style="color:#FFFFFF; font-size:18px;"><?php echo ucwords($candata4['status']); ?> Orders(<?php echo $Monthlyordercancel; ?>)</a></li>
					</ul>
...
<?php if($e1!=''){ ?>
     <table width="100%">
     <tr>
<td colspan="9"><strong style="color:#FF0000; font-size:14px;">No Monthly <?php echo ucwords($adata['status']); ?> Orders Available Yet</strong></td>  
</tr>
     </table> 
     <?php } ?>  
  ...
  <tr>
    <td> <span class="label label-success pull-right sl_status" style="height:24px; line-height:24px;"><strong style="">Monthly Total <?php echo ucwords($adata['status']); ?> Orders </strong></span> </td>
...
<?php if($e2!=''){ ?>
     <table width="100%">
     <tr>
<td colspan="9"><strong style="color:#FF0000; font-size:14px;">No Monthly Orders <?php echo ucwords($trdata1['status']); ?> Available Yet</strong></td>  
</tr>
     </table> 
     <?php } ?>  
         ...
         <table width="80%" border="0">
  <tr>
    <td> <span class="label label-success pull-right sl_status" style="height:24px; line-height:24px;"><strong style="">Monthly Total <?php echo ucwords($trdata1['status']); ?> Orders </strong></span> </td>
    <td> <span class="label label-important pull-right sl_status" style="height:24px; line-height:24px; width:80px;"><strong><?php 
include('route/config1.php');
...
<td colspan="9"><strong style="color:#FF0000; font-size:14px;">No <?php echo ucwords($dvdata2['status']); ?> Orders Available Yet</strong></td>  
     ...
     <?php } ?>  
         ...
         <table width="80%" border="0">
  <tr>
    <td> <span class="label label-success pull-right sl_status" style="height:24px; line-height:24px;"><strong style="">Monthly Total <?php echo ucwords($dvdata2['status']); ?> Orders</strong></span> </td>
    <td> <span class="label label-important pull-right sl_status" style="height:24px; line-height:24px; width:80px;"><strong><?php 
include('route/config1.php');
...
<td colspan="9"><strong style="color:#FF0000; font-size:14px;">No <?php echo ucwords($cpdata3['status']); ?> Orders Available Yet</strong></td>  
     ...
     <?php } ?>  
         ...
         <table width="80%" border="0">
  <tr>
    <td> <span class="label label-success pull-right sl_status" style="height:24px; line-height:24px;"><strong style="">Monthly Total <?php echo ucwords($cpdata3['status']); ?> Orders</strong></span> </td>
    <td> <span class="label label-important pull-right sl_status" style="height:24px; line-height:24px; width:80px;"><strong><?php 
include('route/config1.php');
...
<td colspan="9"><strong style="color:#FF0000; font-size:14px;">No <?php echo ucwords($candata4['status']); ?> Orders Available Yet</strong></td>  
     ...
     <?php } ?>  
         ...
         <table width="80%" border="0">
  <tr>
    <td> <span class="label label-success pull-right sl_status" style="height:24px; line-height:24px;"><strong style="">Monthly Total <?php echo ucwords($candata4['status']); ?> Orders</strong></span> </td>
    <td> <span class="label label-important pull-right sl_status" style="height:24px; line-height:24px; width:80px;"><strong><?php 
include('route/config1.php');
