...
mysql_query ("set character_set_results='utf8'"); 
 $CuisineQuery = $dbb->showtabledata("tbl_aboutUS","id",1);
				...
				<div class="container-fluid">
					<div class="tabbable main-tabs">
						<ul class="nav nav-tabs">
							<li class="active" style="background-color:#f2f2f2;"><a href="#mainFormElements" style="background-color:#f2f2f2;" data-toggle="tab"><i class="icon-file"></i>About Us</a></li>
						</ul>
										...
										<div class="navbar">
                                         ...
                                         <?php
											...
											<div id="display-success">
			                                 <img src="img/correct.png" alt="Success" />About Us has been successfully updated.
		                                     </div>
											<?php }?>
										<div class="row-fluid" >
											<div  class=" span12">
												<form id="SignupForm" action="InsertPhp.php?tag=AboutUsEdit&eid=1" method="post">
...
<input type="submit" class="btn btn-inverse" name="addEditContent"  value="Update About Us" >
</td></tr>
