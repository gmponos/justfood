...
xmlhttp.send();
    ...
    <select class="chzn-select" data-placeholder="Select Restaurant..." onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);"  id="restaurant_id" name="restaurant_id" style="width:317px;" >
   ...
   <td><label for="Name">Country Name</label></td>
    ...
    <select  data-placeholder="Select Country..." onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);"  id="countryID" name="countryID" style="width:317px;" onChange="getOrgTypeListRest(this.value)">
<option value="">Select</option>
   ...
   <td><label for="Name">State Name</label></td>
    ...
    <select  data-placeholder="Select State..." onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);"  id="stateID" name="stateID" style="width:317px;" onChange="getOrgTypeListRestCity(this.value)"  >
   ...
   <td><label for="Name">City Name</label></td>
    ...
    <td >  <select  data-placeholder="Select State..." onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);"  id="cityName" name="cityName" style="width:317px;"  >
