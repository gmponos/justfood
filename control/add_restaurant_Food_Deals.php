...
$filename = "MenuItemImg/MenuItemImgSmall/".$website_favicon;
$filename1 = "MenuItemImg/MenuItemImgSmall/".$website_favicon;
...
<div id="page-wrap">
  ...
  <tr>
    ...
    <td>	<select data-placeholder="Select Restaurant Name..." required name="restaurant_id" id="restaurant_id" onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);" style="width:317px;" onChange="DataSubmit(this.value)">
										<option value="">Select Restaurant</option>
                                            ...
                                            <tr>
    <td><label for="foodDeals_name">Food Deals Title <span style="color:#FF0000;">*</span></label></td>
  ...
  <tr>
    <td><label for="foodDeals_price">Food Deals Price <span style="color:#FF0000;">*</span></label></td>
    <td><input name="foodDeals_price" id="foodDeals_price" required onkeyup="isNumber(this)" onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);" placeholder="" type="text" value="<?php echo $CuisineData['foodDeals_price']; ?>"   style="width:300px;"/> </td>
    </tr>
    <tr>
    ...
    <tr>
    <td colspan=""><label for="restaurant_website">Food Deals Type <span style="color:#FF0000;">*</span></label></td>
    <td colspan="">
 ...
 <?php if($_GET['eid']!=''){ ?>
  ...
  <?php if($_GET['eid']!=''){ ?>
   <tr>
    ...
    <td>
   <img src="MenuItemImg/MenuItemImgSmall/<?php echo $CuisineData['foodDeals_image'];?>" width="150" height="100" />
    </td>
...
<option value="1" <?php if($_GET['statusid']==1){ ?> selected="selected" <?php } ?> >Deactivated</option>
        ...
        ?>
                        ...
                        <?php if($row['status']==0){ ?>
                        <a href="InsertPhp.php?tag=ResfoodDealsActivate&active=1&statusid=<?php echo $row['id'];?>&restaurant_id=<?php echo $row['restaurant_id'];?>" class="btn btn-duasembilan" onClick="return confirm('Are you sure to do this action.');" title="Activate/Deactivate Food Deals">Deactivate</a><?php } else {?>
