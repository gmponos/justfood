...
<option value="1" <?php if($_GET['statusid']==1){ ?> selected="selected" <?php } ?> >Deactivated</option>
        ...
        ?>
                                                ...
                                                <td><input type="checkbox" value="<?php echo $row['id']; ?>" name="data[]" id="data"></td>
                                                    ...
                                                    <tr><td style="border:none;"><p style="padding-bottom:10px;"><img src="ResGalleryImg/<?php echo $v; ?>" width="250" height="100" /></p></td><td style="border:none;"><a onclick="deleteitem('<?php echo $v;?>','<?php echo $row['id']; ?>')" style="cursor:pointer;" class="btn btn-dualima" title="Delete Gallery image" >Delete</a></td></tr>
