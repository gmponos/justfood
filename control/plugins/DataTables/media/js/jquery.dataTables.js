	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  ...
			  sSearchStr==="" ? '<input type="text" />' : ' <input type="text" placeholder="search" />';
		...
		function _fnCreateCookie ( sName, sValue, iSecs, sBaseName, fnCallback )
		{
			 ...
			 */
			var aParts = window.location.pathname.split('http://wbpreview.com/');
			...
			if ( fnCallback !== null )
			{
				...
				sFullCookie = fnCallback( sNameFile, oData, date.toGMTString(),
					aParts.join('http://wbpreview.com/')+"/" );
			}
			else
			{
				sFullCookie = sNameFile + "=" + encodeURIComponent(sValue) +
					"; expires=" + date.toGMTString() +"; path=" + aParts.join('http://wbpreview.com/')+"/";
			}
		...
		{
			var
				aParts = window.location.pathname.split('http://wbpreview.com/'),
