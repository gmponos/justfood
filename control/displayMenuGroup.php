 ...
 window.location="displayMenuGroup.php?menuSizeID="+srt+"&CategoryMenuID=<?php echo $_GET['CategoryMenuID'];?>&RestaurantID=<?php echo $_GET['RestaurantID']; ?>&MenuID=<?php echo $_GET['MenuID']; ?>&restaurant_state=<?php echo $_GET['restaurant_state'];?>&restaurant_city=<?php echo $_GET['restaurant_city'];?>";
    ...
    <form id="SignupForm"  method="post" enctype="multipart/form-data">
      <table  align="center" border="0">
        ...
        <tr>
          <td><label for="menuDoughName">Food Option Name <span style="color:#FF0000;">*</span></label></td>
        ...
        <tr>
         <td><label for="menuDoughPrice">Food Option Price <span style="color:#FF0000;">*</span></label></td>
        ...
        <?php if($_GET['eid']!=''){ ?>
        <tr>
         <td><label for="doughPosition">Food Option Position <span style="color:#FF0000;">*</span></label></td>
          <td><input  name="doughPosition" required onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);" id="doughPosition" value="<?php echo $CuisineData['doughPosition'];?>" onkeypress='return isNumberKey(event);'  type="text"   style="width:300px;"/></td>
        </tr>
