...
<td><input type="text" name="postcode1" id="postcode1" value="<?php echo $CuisineData['postcode']; ?>" style="width:120px; " /></td>

  

    <td><input type="text" name="delivery_areaName1" id="delivery_areaName1" value="<?php echo $CuisineData['delivery_areaName']; ?>" style="width:120px; " /></td>

   

    <td><input type="text" name="delivery_charge1" id="delivery_charge1" onkeyup="isNumber(this)" value="<?php echo $CuisineData['delivery_charge']; ?>" style="width:120px; " /></td>

   

    <td><input type="text" name="minimum_order1" id="minimum_order1" onkeyup="isNumber(this)" value="<?php echo $CuisineData['minimum_order']; ?>" style="width:120px; " /></td>

   

    <td><input type="text" name="shipping_charge1" id="shipping_charge1" value="<?php echo $CuisineData['shipping_charge']; ?>" style="width:120px; " /></td>
    
    <td><input type="text" name="postcodelatitude1" id="postcodelatitude1" value="<?php echo $CuisineData['postcodelatitude']; ?>" style="width:120px; " /></td>
    <td><input type="text" name="postcodelongitude1" id="postcodelongitude1" value="<?php echo $CuisineData['postcodelongitude']; ?>" style="width:120px; " /></td>
  ...
  <tr><td colspan="9">&nbsp;</td></tr>
   ...
   <!-- <tr>
    ...
    <td><input type="text" name="delivery_areaName2" id="delivery_areaName2" value="" style="width:150px; " /></td>

     <td>&nbsp;</td>

    <td><input type="text" name="delivery_charge2" id="delivery_charge2" value="" style="width:150px; " /></td>

     <td>&nbsp;</td>

    <td><input type="text" name="minimum_order2" id="minimum_order2" value="" style="width:150px; " /></td>

     <td>&nbsp;</td>

    <td><input type="text" name="shipping_charge2" id="shipping_charge2" value="" style="width:150px; " /></td>
   ...
   <tr><td colspan="9">&nbsp;</td></tr>
    ...
    <tr>
     ...
     <td><input type="text" name="postcode3" id="postcode3" value="" style="width:150px; " /></td>
