											...
											<div  class=" span12">
												<form id="SignupForm" method="post" enctype="multipart/form-data" onSubmit="return RestaurantBookimngValidate()">
                                                    ...
                                                    <table width="100%" border="0">
                                                     <tr>
    <td><label for="restaurant_id">Restaurant Name</label></td>
    <td>	<select required data-placeholder="Select Restaurant..." onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);"  id="restaurant_id" name="restaurant_id"  >
