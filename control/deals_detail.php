...
if($_GET['ViewId']!='')
{
 $CuisineQuery = $dbb->showtabledata("tbl_restaurantDeals","id",$_GET['ViewId']);
...
<div id="page-wrap">
								...
								<div id="itemContainer">
									...
									<div class="well">
										<div class="navbar">
										   ...
										   { ?>
                            Restaurant Daily Deals Details
                            <?php } else { ?>
                            Update Restaurant Daily Deals
                            <?php } ?></a>
											</div>
										...
										<div class="row-fluid" >
											<div  class="wizardForm span12">
												<form id="SignupForm" action="manage_restaurant_daily_deals.php" method="post" enctype="multipart/form-data">
											<fieldset>
 ...
 <?php echo $CuisineData['RestaurantDealsAddress']; ?>
    ...
    <td colspan="3">
    <?php echo $CuisineData['RestaurantDealsDescription']; ?>
    </td>
  ...
  <?php $imh=explode(',',$CuisineData['RestaurantDealsImageThumb']);
												...
												<input id="submitWizard" type="submit" class="btn btn-primary submitWizard" value="Back >>" />
												</form>
											</div>
										</div>
									</div>
