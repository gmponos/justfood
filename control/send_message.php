...
{
$to=implode(',',$_POST['MultiemialSendTo']);
$subject =''.$AdminDataLoginVal['website_name'].' Newsletter Subscribe';
              ...
              <td rowspan='2'> 
                ...
                <table cellpadding='0' cellspacing='0' width='730'>
                  <tbody>
                   ...
                   <tr>
                          <td > 
<h2 style='color:#000066;margin-left:10px; margin-top:10px;'>Hi Subscriber !</h2>
...
<div id="page-wrap">
										...
										<div class="row-fluid" >
                                         ...
                                         <?php } ?>
												<form  action="" method="post" enctype="multipart/form-data">
													...
													<legend>Newsletter Subscribe information</legend>
  ...
  <tr>
    ...
    <td>
	<select name="MultiemialSendTo[]" required multiple="multiple" style="width:500px; height:120px;">
    <?php 
	$QUlNww=mysql_query("select * from tbl_newselleterSubscribe order by id desc");
	while($EmailDAt=mysql_fetch_assoc($QUlNww))
	{
	?>
    <option value="<?php echo $EmailDAt['subscribe_email'];?>" <?php if($EmailDAt['subscribe_email']== $CuisineData['subscribe_email']){ ?> selected="selected" <?php } ?>><?php echo $EmailDAt['subscribe_email'];?></option>
    <?php } ?>
    </select>
    <br />
   <strong style="color:#009900; font-size:14px;">Select More Item with ctrl+shift</strong>
</td>
 ...
 <tr>
  ...
  <tr><td colspan="4"></td></tr>
   ...
   <br />
   <input type="submit" class="btn btn-primary" name="SubmitOrderstatussubscribe_email" id="SubmitOrderstatussubscribe_email" value="Send Message" /></td></tr>
</table>	                 
