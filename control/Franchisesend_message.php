...
if($_GET['ViewId']!='')
{
 $CuisineQuery = $dbb->showtabledata("tbl_restaurantFranchise","id",$_GET['ViewId']);
...
{
 $to=$CuisineData['franchise_Email'];
 $subject ="Get A Franchise Reply";
 $from=$RegistrationDataLoginVal['contactusemail'];
$message .=  "<html><body>";
$message .= "<table>";
$message .="<tr><td align='left'><font face=Verdana size=2><b>Hi ".$CuisineData['franchise_firstName']." ".$CuisineData['franchise_lastName']." ,</b></font></td></tr>";
					...
					<div class="tabbable main-tabs">
						<ul class="nav nav-tabs">
							<li class="active" style="background-color:#f2f2f2;"><a href="#mainFormElements" style="background-color:#f2f2f2;" data-toggle="tab"><i class="icon-file"></i><?php  if($_GET['ViewId']=='')
										   { ?>
                            Get A Franchise Detail
                            <?php } else { ?>Get A Franchise Detail
                            <?php } ?></a></li>
						</ul>
...
<?php } ?>
										<div class="row-fluid" >
											...
											<fieldset>
													<legend>Get A Franchise information</legend>
                                                    
                                                    <table width="100%" border="0">
                                                     
  <tr>
    <td><label for="RestaurantDealsStartDate">Name</label></td>
    <td><?php echo $CuisineData['franchise_firstName']; ?> <?php echo $CuisineData['franchise_lastName']; ?></td>
    <td><label for="RestaurantDealsStartTime">Email</label></td>
    <td><?php echo $CuisineData['franchise_Email']; ?></td>
  </tr>
  
  <tr>
    <td><label for="RestaurantDealsStartDate">Mobile</label></td>
    <td><?php echo $CuisineData['franchise_mobile']; ?></td>
    <td><label for="RestaurantDealsStartTime">City</label></td>
    <td><?php echo $CuisineData['franchise_city']; ?></td>
  </tr>
  
  <tr>
    <td><label for="RestaurantDealsStartDate">Town</label></td>
    <td><?php echo $CuisineData['franchise_town']; ?></td>
    <td><label for="RestaurantDealsStartTime">Country</label></td>
    <td><?php echo $CuisineData['franchise_country']; ?></td>
  </tr>
  
  <tr>
    <td><label for="RestaurantDealsStartDate">How much you are looking to invest in this venture?</label></td>
    <td><?php echo $CuisineData['franchise_invest']; ?></td>
    <td><label for="RestaurantDealsStartTime">Country of Interest</label></td>
    <td><?php echo $CuisineData['franchise_Selectedcountry']; ?></td>
  </tr>
  <tr>
    ...
    <td><?php echo $CuisineData['created_date']; ?></td>
                                    ...
                                    <fieldset>
													<legend>Reply Message To Get A Franchise Customer</legend>
