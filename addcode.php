...
$('.star a').hover(function(){
  ...
  $('a').click(function(){
        var val = $(this).text();
		var hotel = "<?php echo $_GET['hotel_id'];?>";
		var loginID = "<?php echo $_SESSION['justfoodsUserID'];?>";
...
if($sss >= 1)
  ...
  $qur1 = "select count(*) as dd, avg(rateval) as xx from $tablename where hotel_id='".$_GET['hotel_id']."' and userID='".$_SESSION['justfoodsUserID']."'";
