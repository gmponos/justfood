...
<head>
        ...
        <style type="text/css">
::-webkit-scrollbar-track-piece{background-color: #6F6D6D;border-left: 1px solid #CCC;-webkit-box-shadow: inset 0 0 12px rgba(0,0,0,0.3);}
::-webkit-scrollbar{width:10px;height:10px;);}
::-webkit-scrollbar-thumb{background-color:#E31616;}
::-webkit-scrollbar-thumb:hover{height:50px;background-color:#E31616;-webkit-border-radius:4px;}
::moz-scrollbar-track-piece{background-color: #00ccff;border-left: 1px solid #CCC;moz-box-shadow: inset 0 0 12px rgba(0,0,0,0.3);}
::moz-scrollbar{width:10px;height:10px;);}
::moz-scrollbar-thumb{background-color:#ff6156;}
::moz-scrollbar-thumb:hover{height:50px;background-color:#ff6156;moz-border-radius:4px;}
 ...
 <!-- mid search  starts-->
  ...
  <div class="steps">
   <ul>
                ...
                <li> <a href="#" class="selected"> <span class="selected">2</span> Select Restaurant </a> </li>
...
if($_GET['restaurantState']!='' && $_GET['restaurantCity']!='' && $_GET['restaurant_cuisine']!='')
{
$Bracumb=$_GET['restaurant_cuisine'].','.$_GET['restaurantCity'].','.$_GET['restaurantState'].'';
}
else if($_GET['restaurantState']!='' && $_GET['restaurantCity']!='')
{
$Bracumb=$_GET['restaurantState'].','.$_GET['restaurantCity'];
}
...
{
$Bracumb=$_GET['restaurant_cuisine'].','.$_GET['restaurantState'];
}
else if($_GET['restaurantState']!='')
{
$Bracumb=$_GET['restaurantState'].','.$_GET['restaurantState'];
}
else if($_GET['restaurant_cuisine']!='')
{
...
<div class="list-h">
                 ...
                 <?php echo  $Bracumb;?></span> </h2><h2><a href="#" style="color:#777;">change of address </a></h2>
                  
                </div>
                <table width="100%"  cellpadding="0"  cellspacing="0" border="0" class="table table-striped " <?php if($numrows>0){?>id="example" <?php } ?>>
	<thead>
		<tr style="background:url(images/img/results-stripe-bg.png) repeat-x top; height:40px; font-size:16px; font-family:Calibri;">
			<th style="width:355px; ">Restaurants</th>
			<!--<th style="width:80px;">Price</th>-->
			<th style="width:110px; text-align:center;">Grade</th>
			<th style="width:115px; text-align:center;">Delivery Time</th>
			<th style="width:100px; text-align:center;">Min. Order</th>
            <th style="width:70px; text-align:center;">Deals</th>
			<th style=" margin-right:1px;width:110px; text-align:center;">Status</th>
		</tr>
	</thead>
	<tbody >
    ...
    <tr style="border:none;">
         ...
         <?php /*?> <div class="rest_deals">
			...
			<td style="border-right:1px solid #ccc;"><div class="rest_grade">
            <a href="">
   ...
   include('TimeTable.php');
    ?>
                              ...
                              <div class="showtime" >
                          <a class="tooltips"  href="#">View Timing
			...
			<td style="border-right:1px solid #ccc;"><div class="rest_delivery"><span class="b18b"><font><font><?php echo stripslashes(ucwords($data['restaurant_avarage_deliveryTime']));?> </font></font></span>
			...
			<td style="border-right:1px solid #ccc;"><div class="rest_min"><span class="b18b"><font><font><?php echo $data['restaurant_default_min_order'];?> €</font></font></span>
            
            </div></td>
            
            <td style="border-right:1px solid #ccc;"><div class="rest_deals">
             <?php $RestaurantOffer=mysql_fetch_assoc(mysql_query("select * from tbl_restaurantOffer where restaurant_id='".$data['id']."'")); ?>									<?php if($RestaurantOffer['RestaurantOfferPrice']!=''){ ?>
             <link href="../tooltip/tooltip/themes/1/tooltip.css" rel="stylesheet" type="text/css" />
    <script src="../tooltip/tooltip/themes/1/tooltip.js" type="text/javascript"></script>
            ...
            <img src="images/img/4.png" title="" />           
            ...
            <?php } else{?>
            <div class="btn_order"> 
             <a href="restaurant.php?restaurants=<?php echo stripslashes(ucwords($data['id']));?>-<?php echo urlencode(trim($data['restaurantCity']));?>-<?php echo urlencode(trim($data['restaurant_name']));?>.html"><?php echo $OrderButton;?></a>
            </div>
            <?php } ?>
            </div>
            </td>
