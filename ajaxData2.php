...
$MonSlotPrice= $MainMenuSingleData['MenuSlotPrice'];
}
else
{
 $MonSlotPrice= $MainMenuSingleData['RestaurantPizzaItemPrice'];
}
 if($ItemPrice['SizeMenuPrice']=='')
 {
 $todtamenu=$MonSlotPrice;
 }
 else
 {
 //$todtamenu=0;
...
<form class="addtc" name="myform" action="onlineBids.php?RestaurantPizzaID=<?php echo $StData['id'];?>&menuofferID=<?php echo $_SESSION['menuofferID'];?>&restaurants=<?php echo stripslashes(ucwords($StData['id']));?>-<?php echo urlencode(trim($StData['restaurantCity']));?>-<?php echo urlencode(trim($StData['restaurant_name']));?>.html" target="_parent"  method="post">
 ...
 <div style="float:left; width:100%; min-height:20px; padding-bottom:2px;">
       <?php if($ExtraMainMenuOPtion1DataGroup['menuExtraQuantity']==1 || $ExtraMainMenuOPtion1DataGroup['menuExtraQuantity']=='' ){?>
        ...
        <?php if($ExtraMainMenuOPtion1Data['menuExtraChecked']==1){ ?>
          ...
          <?php } else { ?>
           <input style="width:10px; height:10px;" type="checkbox" <?php if($ExtraMainMenuOPtion1DataGroup['menuExtraCheckedSelection']==1){ ?>  checked="checked" <?php }?> <?php if($kmop1>=3){ ?> onclick="alert('Sorry ! You have selected max number of data')" <?php } else { ?> onclick="getExtarValueAjax1('<?php echo $ExtraMainMenuOPtion1DataGroup['id']?>','<?php echo $_GET['menuID'];?>','<?php echo $_GET['restaurantID'];?>','<?php echo $_GET['size'];?>','<?php echo $_GET['dough'];?>','<?php echo $_GET['base'];?>','<?php echo $_GET['chees'];?>','1','1','<?php echo $_GET['PriceBalance'];?>')" <?php } ?> />
          <?php } ?>
        </div>
      </div>
	...
	?> <?php echo $AdminDataLoginVal['website_CurrencySymbole']; ?></td>
      ...
      <div style="width:11%; min-height:30px; float:left;">
        ...
        <?php if($ExtraMainMenuOPtion1Data['menuExtraChecked']==1){ ?>
          <input type="checkbox"  checked="checked"  disabled="disabled" />
          <?php } else { ?>
          <input type="checkbox" <?php if($ExtraMainMenuOPtion1DataGroup['menuExtraCheckedSelection']==2){ ?> checked="checked" <?php }?> <?php if($kmop1>=3){ ?> onclick="alert('Sorry ! You have selected max number of data')"<?php } else { ?> onclick="getExtarValueAjax1('<?php echo $ExtraMainMenuOPtion1DataGroup['id']?>','<?php echo $_GET['menuID'];?>','<?php echo $_GET['restaurantID'];?>','<?php echo $_GET['size'];?>','<?php echo $_GET['dough'];?>','<?php echo $_GET['base'];?>','<?php echo $_GET['chees'];?>','2','2','<?php echo $_GET['PriceBalance'];?>')" <?php } ?> />
          <?php } ?>
        </div>
      </div>
