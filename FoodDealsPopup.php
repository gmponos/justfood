...
$FoodDealsData=mysql_fetch_assoc(mysql_query("select * from tbl_foodDeals where status='0' and restaurant_id='".$_GET['restaurant_id']."' and id='".$_GET['FoodDealsID']."'"));
?>
...
<div class="cartwrapper">
  ...
  <div class="cartcontainer">
    <div class="cartcontent" id="myDiv">
      <div>
        <h2>Edit Deal for item <?php echo ucwords($FoodDealsData['foodDeals_name']);?><span id="PriceChange" style="float:right;"> <?php echo $FoodDealsData['foodDeals_price'];?> <?php echo $AdminDataLoginVal['website_CurrencySymbole']; ?> </span></h2>
        ...
        <div class="cart_main">
          <form class="addtc" id="myform" action="restaurant.php?restaurants=<?php echo urlencode(trim($_GET['restaurants'])); ?>" target="_parent" method="post">
            <input type="hidden" name="deal_id" value="<?php echo $FoodDealsData['id'];?>"  />
            <input type="hidden" name="deal_name" value="<?php echo $FoodDealsData['foodDeals_name'];?>"  />
            <input type="hidden" name="deal_price" value="<?php echo $FoodDealsData['foodDeals_price'];?>"  />
            <?php $FoodSlot=mysql_query("select * from tbl_fooddealsSlot where fooddeals_id='".$FoodDealsData['id']."' and status='0'");
...
?>
                    ...
                    <option value="<?php echo $SlotDataNameItem['id'];?>"><?php echo $SlotDataNameItem['slot_itemName'];?></option>
                    <?php } } else {?>
