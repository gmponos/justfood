<div class="mid_product">
 ...
 <h2 style="float:left; margin-right:5px;"><?php echo $TableLanguage['CuisinesText'];?> :</h2><h3 style="margin-top:6px; margin-left:5px;"> <?php $cuisin=explode(',',$resdata['restaurant_cuisine']);
			$ggphoto='';
			foreach($cuisin as $c)
			{
			$ggphoto.=$c.' ,';
			...
			?></h3>
                         ...
                         <?php /*?>  <?php if($resdata['rating']==5){ ?>
                          <img src="images/img/Star-icon.gif">
                          <img src="images/img/Star-icon.gif">
                          <img src="images/img/Star-icon.gif">
                          <img src="images/img/Star-icon.gif">
                          <img src="images/img/Star-icon.gif"> (<a href="#">5 Ratings</a>)
                          <?php } elseif($resdata['rating']==4){?>
                           <img src="images/img/Star-icon.gif">
                          <img src="images/img/Star-icon.gif">
                          <img src="images/img/Star-icon.gif">
                          <img src="images/img/Star-icon.gif">
                          <img src="images/img/Star-icon-grey.gif"> (<a href="#">4 Ratings</a>)
                          
                           <?php } elseif($resdata['rating']==3){?>
                           <img src="images/img/Star-icon.gif">
                          <img src="images/img/Star-icon.gif">
                          <img src="images/img/Star-icon.gif">
                          <img src="images/img/Star-icon-grey.gif">
                          <img src="images/img/Star-icon-grey.gif"> (<a href="#">3 Ratings</a>)
                        
                            <?php } elseif($resdata['rating']==2){?>
                           <img src="images/img/Star-icon.gif">
                          <img src="images/img/Star-icon.gif">
                         <img src="images/img/Star-icon-grey.gif">
                          <img src="images/img/Star-icon-grey.gif">
                          <img src="images/img/Star-icon-grey.gif"> (<a href="#">2 Ratings</a>)
                         
                            <?php } elseif($resdata['rating']==1){?>
                           <img src="images/img/Star-icon.gif">
                           <img src="images/img/Star-icon-grey.gif">
                         <img src="images/img/Star-icon-grey.gif">
                          <img src="images/img/Star-icon-grey.gif">
                          <img src="images/img/Star-icon-grey.gif"> (<a href="#">1 Ratings</a>)
                          <?php } else { ?>
						    <img src="images/img/Star-icon-grey.gif">
                           <img src="images/img/Star-icon-grey.gif">
                         <img src="images/img/Star-icon-grey.gif">
                          <img src="images/img/Star-icon-grey.gif">
                          <img src="images/img/Star-icon-grey.gif"> (<a href="#">0 Ratings</a>)
                          <?php } ?><?php */?>
                          
                         
                            <!--<a class="favourite" href="#">Add to Favourite</a>-->
 ...
 <div class="product_favorites">
                 ...
                 <a href="">
                         ...
                         </a><!--<a href="">View all Opening Times</a>--></h2>
 ...
 <h2 style="margin-bottom:0px;"><?php echo $TableLanguage4['ResMinDeliveryFee'];?></h2>
...
<div class="fb-share-button" data-href="https://www.facebook.com/pages/Mega-Menus/252052911617336" data-type="button_count"></div>
                          ...
                          <img style=" margin-top:5px;" src="images/mail.png" title="<?php echo ucwords($TableLanguage4['ResEmailRestaurant']);?>" width="30" height="20" />
                          <p><a href="#"><?php echo $TableLanguage4['ResEmailRestaurant'];?></a></p>
                          <div id="displayFav">
                           ...
                           <p><?php echo $TableLanguage7['FavouriteDoneText'];?>!</p></a>
                           <?php } else { ?>
