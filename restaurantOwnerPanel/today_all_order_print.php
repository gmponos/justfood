...
{		
$sql = "SELECT * FROM resto_order where restoid='".$_GET['restaurant_id']."' and odr_date='$curdate' order by order_id desc ";
}
else
{
$sql = "SELECT * FROM resto_order where odr_date='$curdate' order by order_id desc ";
}
