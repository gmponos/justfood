...
$excel=new ExcelWriter("MonthlyRestaurantOrder.xls");
if($excel==false)	
$excel->error;
$myArr=array("");
...
$CuisineQuery = $dbb->showtabledata("tbl_restaurantAdd","id",$data['restoid']);
 ...
 $OwnerName=$OwnerData['restaurant_OwnerFirstName'].''.$OwnerData['restaurant_OwnerLastName'];
		...
		$myArr=array($restaurantName,$data['order_identifyno'],$data['odr_date'],$data['ordPrice'],$restaurantCommission,$data['order_type'],$data['payMode'],$OwnerName,$fullName,$UserData['user_email'],$UserData['address'],$UserData['user_phone']);
		$excel->writeLine($myArr);
		$i++;
	}
}
				...
				<div class="container-fluid">
					<div class="tabbable main-tabs">
						<ul class="nav nav-tabs">
							<li class="active" style="background-color:#f2f2f2;"><a href="#mainFormElements" style="background-color:#f2f2f2;" data-toggle="tab"><i class="icon-file"></i>Monthly Restaurant Orders Report</a></li>
						</ul>
									...
									<div class="well">
										<div class="navbar">
											<div class="navbar-inner">
												<a class="brand" href="#">Monthly Restaurant Orders Report </a>
											</div>
										</div>
										<div class="row-fluid">
    <div class="span12">
...
{
window.location.href="Monthly_restaurantOrder_print.php?sort="+str+"&f="+Dvalue;
}
</script>
    <table width="70%" border="0">
    <tr>
    <td><a href="MonthlyRestaurantOrder.xls" class="btn btn-info" title="Export into CVS Format" >Export into Excel Format</a></td>
    <td> <?php if($_GET['restaurant_id']!=''){ ?>
    <a href="MonthlyexportOrderCVS.php?restaurant_id=<?php echo $_GET['restaurant_id'];?>" class="btn btn-primary" title="Export into CVS Format" >Export into CVS Format</a>
    <?php } else { ?>
     <a href="MonthlyexportOrderCVS.php" class="btn btn-primary" title="Export into CVS Format" >Export into CVS Format</a>
    <?php } ?></td>
    <td>
       <?php if($_GET['restaurant_id']!=''){ ?>
    <a href="tcpdf/examples/Monthly_restaurantOrder_PDF.php?restaurant_id=<?php echo $_GET['restaurant_id'];?>" target="_blank" class="btn btn-tigadua" title="Generate PDF" >Generate PDF</a>
    <?php } else{ ?>
    <a href="tcpdf/examples/Monthly_restaurantOrder_PDF.php" target="_blank" class="btn btn-tigadua" title="Generate PDF" >Generate PDF</a>
    <?php  } ?>
    </td>
    <td>
     <?php if($_GET['restaurant_id']!=''){ ?>
    <a href="monthly_all_order_print.php?restaurant_id=<?php echo $_GET['restaurant_id'];?>" class="btn btn-duasembilan" title=" Print Restaurant Orders" target="_blank" > Print Restaurant Orders</a>
    <?php } else { ?>
    
     <a href="monthly_all_order_print.php" class="btn btn-duasembilan" title=" Print Restaurant Orders" target="_blank" > Print Restaurant Orders</a>
    <?php } ?>
    </td>
  </tr>
...
$CuisineQuery = $dbb->showtabledata("tbl_restaurantAdd","id",$data['restoid']);
 ...
 $Cpl='0.00';
		 ...
		 ?>
                ...
                <tr>
                <td colspan="8"><strong style="color:#FF0000; padding:10px; font-size:16px;">This Month ! No Orders available for Printable</strong></td>
                </tr>
                <?php } ?>
                <tr>
