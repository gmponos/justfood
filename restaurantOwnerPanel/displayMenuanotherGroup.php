  ...
  <div  class=" span12">
    ...
    <form id="SignupForm"  method="post" enctype="multipart/form-data">
      <table  align="center" border="0">
        <tr>
          <td><label for="OptionOneTitle">Food Size</label></td>
        ...
        <tr>
          <td><label for="menuBaseName">Food Option Name </label></td>
        ...
        <tr>
         <td><label for="menuBasePrice">Food Option Price</label></td>
          <td><input  name="menuBasePrice" required onkeyup="isNumber(this)" onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);" id="menuBasePrice" value="<?php echo $CuisineData['menuBasePrice'];?>"  type="text"   style="width:300px;"/></td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
        </tr>
         <?php if($_GET['eid']!=''){ ?>
        <tr>
         <td><label for="basePosition">Food Option Position</label></td>
          <td><input  name="basePosition" required onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);" id="basePosition" value="<?php echo $CuisineData['basePosition'];?>"  type="text"   style="width:300px;"/></td>
        </tr>
