...
window.location.href="displayMenuanotherGroup1.php?restaurant_state=<?php echo $_GET['restaurant_state'];?>&restaurant_city=<?php echo $_GET['restaurant_city'];?>&MenuID=<?php echo $_GET['MenuID'];?>&RestaurantID=<?php echo $_GET['RestaurantID'];?>&CategoryMenuID=<?php echo $_GET['CategoryMenuID'];?>&menuSizeID=<?php echo $_GET['menuSizeID'];?>&menudoughID=<?php echo $_GET['menudoughID'];?>&menubasedID="+str2;
    ...
    <form id="SignupForm"  method="post" enctype="multipart/form-data">
      <table  align="center" border="0">
        ...
        <tr>
          <td><label for="menuCheesName">Food Option Name </label></td>
        ...
        <tr>
         <td><label for="menuCheesPrice">Food Option Price</label></td>
        ...
        <?php if($_GET['eid']!=''){ ?>
        <tr>
         <td><label for="cheesPosition">Food Option Position</label></td>
          <td><input  name="cheesPosition" required onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);" id="cheesPosition" value="<?php echo $CuisineData['cheesPosition'];?>"  type="text"   style="width:300px;"/></td>
        </tr>
