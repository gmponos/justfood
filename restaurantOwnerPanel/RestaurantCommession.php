...
$excel->writeLine($myArr);
$qry=mysql_query("SELECT * FROM resto_order where status='4' and restoid='".$_SESSION['restaurant_id']."'  order by order_id desc");
if($qry!=false)
{
	$dSmOdr='';
		$totalSum='';
...
xmlhttp.send();
  ...
  <tr>
    ...
    <td><input id="RestaurantOrderDateStart" name="RestaurantOrderDateStart" value="" data-date-format="yyyy-mm-dd" type="text" class="datePicker" placeholder='start Date'   style="width:300px;"/></td>
    <td><input value="" data-date-format="yyyy-mm-dd" type="text" name="RestaurantOrderDateEnd" id="RestaurantOrderDateEnd"  class="datePicker" placeholder='End Date'   style="width:300px;" /></td>
...
$sql = "SELECT * FROM resto_order where status='4' and restoid='".$_SESSION['restaurant_id']."' $sortBy ";
