    ...
    <form id="SignupForm"  method="post" enctype="multipart/form-data">
      ...
      <?php $numSize =mysql_num_rows(mysql_query("select * from tbl_restaurantMainMenuItemSize where SizeRestaurantMenuItemID='".$_GET['MenuID']."' and status='0' order by SizeMenuName asc"));
       ...
       <tr>
        ...
        <?php } ?>
        <tr>
          <td><label for="menuExtraName">Food Group Topping Title Name </label></td>
      ...
      <table width="100%">
        <tr>
          <td width="23%" align="center"><label for="menuExtraName">Topping Name </label></td>
           <td width="22%" align="center"><label for="menuCheesPrice">Topping Price</label></td>
      ...
      <?php } ?>
        ...
        <tr>
         ...
         <td><label for="menuExtraPrice">Material Quantity</label></td>
          <td><input  name="menuExtraQuantity" onkeyup="isNumber(this)"  onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);" id="Quantity" value="<?php echo $CuisineData['menuExtraQuantity'];?>"  type="text"   style="width:300px;"/></td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
        </tr>
        ...
        <tr style="display:none;">
         <td><label for="menuExtraPrice">Max No. of Checkboxes Selected</label></td>
          <td><input  name="menuExtraMaxnumberCheckbox" onkeyup="isNumber(this)"  onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);" id="menuExtraMaxnumberCheckbox" value="<?php echo $CuisineData['menuExtraMaxnumberCheckbox'];?>"  type="text"   style="width:300px;"/></td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
        </tr>
