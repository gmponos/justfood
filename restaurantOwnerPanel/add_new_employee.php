...
<link href="css/multiple_image_display.css" type="text/css" rel="stylesheet" />
    ...
    <td><?php
										...
										<div class="row-fluid" >
											<div  class=" span12">
												...
												<input type="hidden" name="ResEmployeeID" value="<?php echo $_SESSION['restaurant_id'];?>" />
  ...
  <tr>
   ...
   <tr>
    ...
    <td><img src="../control/EmployeePhoto/<?php echo $CuisineData['EmployeePhoto'];?>" width="120" height="80" /></td>
    <td><label for="restaurant_Market_bannerImg">Employee ID Proof</label></td>
    <td><img src="../control/EmployeeIDproof/<?php echo $CuisineData['EmployeeIDProof'];?>" width="120" height="80" /></td>
  </tr>
  <?php } ?>
   <tr>
