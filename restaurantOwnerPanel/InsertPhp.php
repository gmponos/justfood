...
if(move_uploaded_file($_FILES['RestaurantEventImg']['tmp_name'][$i],"../control/EventImg/thumb/".$_FILES['RestaurantEventImg']['name'][$i])){
}
}
}
...
if(move_uploaded_file($_FILES['restaurant_gallery_image']['tmp_name'][$i],"../control/ResGalleryImg/".$_FILES['restaurant_gallery_image']['name'][$i])){
}
}
}
...
if(move_uploaded_file($_FILES['RestaurantDealsImage']['tmp_name'][$i],"../control/DealsImg/thumb/".$_FILES['RestaurantDealsImage']['name'][$i])){
}
}
}
...
$UserInsert = $db->storeAddResUser($fname,$lname,$countryID,$stateID,$cityName,$zipcode,$gender,$landmark,$user_phone,$address,$user_email,$user_pass);
  if($UserInsert)
  {
...
if($_GET['tag']=='ResUserEdit') {
 $fname = $_POST['fname'];
    $lname = $_POST['lname'];
	 ...
	 $landmark = $_POST['landmark'];
	 $user_pass = $_POST['user_pass'];
$CuisineInsert = $db->storeUpdateResUser($fname,$lname,$countryID,$stateID,$cityName,$zipcode,$gender,$landmark,$user_phone,$address,$user_email,$user_pass,$_GET['eid']);
 			if($CuisineInsert)
 			{
...
$filename = "../control/DeliveryBoyPhoto/".$ResPizzaImg;
$filename1 = "../control/DeliveryBoyPhoto/".$ResPizzaImg;
...
if(move_uploaded_file($_FILES['DeliveryBoyIDProofimg']['tmp_name'],"../control/DeliveryBoyIDproof/".$kp1)){
}
}
...
$filename = "../control/EmployeePhoto/".$ResPizzaImg;
$filename1 = "../control/EmployeePhoto/".$ResPizzaImg;
...
if(move_uploaded_file($_FILES['EmployeeIDProofimg']['tmp_name'],"../control/EmployeeIDproof/".$EmployeeIDProof)){
}
}
...
if(move_uploaded_file($_FILES['EmployeeIDProofimg']['tmp_name'],"../control/EmployeeIDproof/".$kp1)){
}
}
else
{
...
if($_GET['tag']=='RestaurantAdd') {
	...
	//++++++++++++++++++++++Restaurant Information Field+++++++++++++++++++
		...
		$restaurant_FeedbackEmail = $_POST['restaurant_FeedbackEmail'];
	  	...
	  	$restaurant_LatitudePoint = $_POST['restaurant_LatitudePoint'];

	   	$restaurant_LongitudePoint = $_POST['restaurant_LongitudePoint'];
...
$filename = "../control/RestaurantFaviconimg/".$restaurant_FaviconImg;

$filename1 = "../control/RestaurantFaviconimg/small/".$restaurant_FaviconImg;
...
$filename = "../control/restaurantlogoimg/".$restaurant_Logo;

$filename1 = "../control/restaurantlogoimg/small/".$restaurant_Logo;
...
$filename = "../control/RestaurantMarketBannerimg/".$restaurant_Market_bannerImg;

$filename1 = "../control/RestaurantMarketBannerimg/small/".$restaurant_Market_bannerImg;
...
if($_GET['tag']=='RestaurantEdit') {
 ...
 //++++++++++++++++++++++Restaurant Information Field+++++++++++++++++++
		...
		if($_POST['restaurant_cuisine']!=''){
		 ...
		 $restaurant_payment_method =$_POST['rerestaurant_payment_methodold'];
...
$filename = "../control/BannerImage/".$ResPizzaImg;
$filename1 = "../control/BannerImage/small/".$ResPizzaImg;
imagejpeg($tmp,$filename,100);
imagejpeg($tmp1,$filename1,100);
