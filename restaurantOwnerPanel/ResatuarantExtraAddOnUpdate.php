...
xmlhttp.send();
  ...
  <tr>
    <td><label>Menu Category <span class="f_req">*</span></label></td>
    
    <td>	
   <select  id="menuCatgeory" name="menuCatgeory" style="width:317px;" >
    <option value="">Select Menu Category</option>
											  <?php 
											   $StateQuery = mysql_query("select * from tbl_restMenuCategory where restaurantMenuID='".$_SESSION['restaurant_id']."' order by restaurantMenuName asc ");
   ...
   <tr>
    <td><label>Addons <span class="f_req">*</span></label></td>
    <td>
    <div id="newlink">
 <table width="100%">
   <tr >
    <td>Name <input type="text" name="MenuAddOnName" style="width:250px;" onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);"  id="MenuAddOnName" value="<?php echo $CuisineData['MenuAddOnName'];?>"></td>
    
    <td>Price <input type="text" name="MenuAddOnPrice" onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);"  id="MenuAddOnPrice" style="width:250px;" value="<?php echo $CuisineData['MenuAddOnPrice'];?>"></td>
