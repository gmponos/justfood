...
<div id="page-wrap">
  ...
  <?php if($_GET['eid']!=''){ ?>
   <tr>
    ...
    <td><img src="../control/DeliveryBoyPhoto/<?php echo $CuisineData['DeliveryBoyPhoto'];?>" width="120" height="80" /></td>
    <td><label for="restaurant_Market_bannerImg">Market Banner Image</label></td>
    <td><img src="../control/DeliveryBoyIDproof/<?php echo $CuisineData['DeliveryBoyIDProof'];?>" width="120" height="80" /></td>
  </tr>
  <?php } ?>
