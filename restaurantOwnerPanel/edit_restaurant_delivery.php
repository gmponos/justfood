...
<td><input type="text" name="postcode1" id="postcode1" value="<?php echo $CuisineData['restaurant_postcode']; ?>" style="width:120px; " /></td>
    ...
    <td><input type="text" name="delivery_charge1" id="delivery_charge1" value="<?php echo $CuisineData['restaurant_delivery_charge']; ?>" style="width:120px; " /></td>

    <td><input type="text" name="minimum_order1" id="minimum_order1" value="<?php echo $CuisineData['restaurant_minimum_order']; ?>" style="width:120px; " /></td>
