...
$filename = "../control/MenuItemImg/".$ResPizzaImg;
$filename1 = "../control/MenuItemImg/MenuItemImgSmall/".$ResPizzaImg;
...
function isNumber(field) { 
     ...
     <input type="hidden" name="ResPizzaImgold" id="ResPizzaImgold" value="<?php echo $CuisineData['ResPizzaImg'];?>" />
      ...
      <table  align="center" border="0">
        <tr>
          ...
          <td width="380"><select  onChange="redirec(this.value)"  data-placeholder="Select Restaurant Name..." id="RestaurantCategoryID" onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);" name="RestaurantCategoryID" style="width:317px;">
               <?php 
											 if($_GET['RestaurantPizzaID']!=''){
  ...
  <?php if($_GET['eid']!=''){ ?>
   <tr>
    ...
    <td colspan="3">
   <img src="../control/MenuItemImg/MenuItemImgSmall/<?php echo $CuisineData['ResPizzaImg'];?>"  />
    </td>
