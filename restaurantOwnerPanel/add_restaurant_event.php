...
<div id="page-wrap">
  ...
  <tr>
    ...
    <td>	<select class="chzn-select" data-placeholder="Select Restaurant Name..." required onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);"  id="RestaurantEventID" name="RestaurantEventID" style="width:317px;">
...
function delIt(eleId)
{
  ...
  <?php $imh=explode(',',$CuisineData['RestaurantEventImgThumb']);
													...
													if($v!='')
													{?>
                                                    <img src="../control/EventImg/thumb/<?php echo $v; ?>" width="250" height="100" /><br />
													<?php }
													 }
