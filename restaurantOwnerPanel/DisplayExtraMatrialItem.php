      ...
      <table  align="center" border="0">
        ...
        <tr>
         <td><label for="extraPosition">Material Position</label></td>
          <td><input  name="extraPosition" required onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);" id="extraPosition" value="<?php echo $CuisineData['extraPosition'];?>"  type="text"   style="width:300px;"/></td>
        </tr>
        ...
        <?php } ?>
         ...
         <td><label for="menuExtraPrice">Material Quantity</label></td>
          <td><input  name="menuExtraQuantity" required onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);" id="Quantity" value="<?php echo $CuisineData['menuExtraQuantity'];?>"  type="text"   style="width:300px;"/></td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
        </tr>
