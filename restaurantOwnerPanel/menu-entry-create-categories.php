										...
										<div class="row-fluid" >
											<div  class=" span12">
												<form id="SignupForm" action="<?php echo $url; ?>" method="post" enctype="multipart/form-data" onsubmit="return RestaurantMenuCategoryValidate();">
												 <input type="hidden" name="RestaurantPizzaID" value="<?php echo $_SESSION['restaurant_id'];?>" />
												
                                                    <table  align="center" border="0">
                                              
                                          
           <tr>                                 
    <td><label for="restaurantMenuName">Menu Category Name</label></td>
    <td><input id="restaurantMenuName" name="restaurantMenuName" onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);"  value="<?php echo $CuisineData['restaurantMenuName'];?>" type="text"  style="width:300px;"/></td>
  </tr>
  <?php if($_GET['eid']!=''){ ?>
     <tr>                                 
    <td><label for="menuPosition">Menu View Position</label></td>
    <td><input id="menuPosition" name="menuPosition" onMouseOver="return clearFieldValue(this);" required onClick="return clearFieldValue(this);"  value="<?php echo $CuisineData['menuPosition'];?>" type="text"  style="width:200px;"/></td>
  </tr>
  <?php } ?>
