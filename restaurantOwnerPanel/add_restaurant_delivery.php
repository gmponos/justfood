...
xmlhttp.send();
   ...
   <td><label for="Name">Country Name</label></td>
    ...
    <select class="chzn-select" data-placeholder="Select Country..." onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);"  id="countryID" name="countryID" style="width:317px;" onChange="getOrgTypeListRest(this.value)">
   ...
   <td><label for="Name">State Name</label></td>
    ...
    <select class="chzn-select" data-placeholder="Select State..." onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);"  id="stateID" name="stateID" style="width:317px;" onChange="getOrgTypeListRestCity(this.value)"  >
   ...
   <td><label for="Name">City Name</label></td>
    ...
    <td id="cityName">  <select class="chzn-select" data-placeholder="Select State..." onMouseOver="return clearFieldValue(this);" onClick="return clearFieldValue(this);"  id="cityName" name="cityName" style="width:317px;"  >
  ...
  <tr>
    ...
    <td><input type="text" name="delivery_charge1" id="delivery_charge1" value="" style="width:120px; " /></td>

     
    <td><input type="text" name="minimum_order1" id="minimum_order1" value="" style="width:120px; " /></td>
  ...
  <tr><td colspan="9">&nbsp;</td></tr>
    ...
    <td><input type="text" name="delivery_charge2" id="delivery_charge2" value="" style="width:120px; " /></td>

    
    <td><input type="text" name="minimum_order2" id="minimum_order2" value="" style="width:120px; " /></td>
 ...
 <td><input type="text" name="postcodelatitude2" id="postcodelatitude2" value="" style="width:120px; " /></td>
   ...
   <tr><td colspan="9">&nbsp;</td></tr>
    ...
    <td><input type="text" name="delivery_charge3" id="delivery_charge3" value="" style="width:120px; " /></td>

    <td><input type="text" name="minimum_order3" id="minimum_order3" value="" style="width:120px; " /></td>
   ...
   <tr><td colspan="9">&nbsp;</td></tr>
    ...
    <td><input type="text" name="delivery_charge4" id="delivery_charge4" value="" style="width:120px; " /></td>

    <td><input type="text" name="minimum_order4" id="minimum_order4" value="" style="width:120px; " /></td>
...
<tr><td colspan="9">&nbsp;</td></tr>
    ...
    <td><input type="text" name="delivery_charge5" id="delivery_charge5" value="" style="width:120px; " /></td>

   
    <td><input type="text" name="minimum_order5" id="minimum_order5" value="" style="width:120px; " /></td>
  ...
  <tr><td colspan="9">&nbsp;</td></tr>
    ...
    <td><input type="text" name="delivery_charge6" id="delivery_charge6" value="" style="width:120px; " /></td>

    

    <td><input type="text" name="minimum_order6" id="minimum_order6" value="" style="width:120px; " /></td>
  ...
  <tr><td colspan="9">&nbsp;</td></tr>
    ...
    <td><input type="text" name="delivery_charge7" id="delivery_charge7" value="" style="width:120px; " /></td>

    

    <td><input type="text" name="minimum_order7" id="minimum_order7" value="" style="width:120px; " /></td>
...
<tr><td colspan="9">&nbsp;</td></tr>
    ...
    <td><input type="text" name="delivery_charge8" id="delivery_charge8" value="" style="width:120px; " /></td>

    

    <td><input type="text" name="minimum_order8" id="minimum_order8" value="" style="width:120px; " /></td>
  ...
  <tr><td colspan="9">&nbsp;</td></tr>
    ...
    <td><input type="text" name="delivery_charge9" id="delivery_charge9" value="" style="width:120px; " /></td>

    

    <td><input type="text" name="minimum_order9" id="minimum_order9" value="" style="width:120px; " /></td>
...
<tr><td colspan="9">&nbsp;</td></tr>
    ...
    <td><input type="text" name="delivery_charge10" id="delivery_charge10" value="" style="width:120px; " /></td>

    

    <td><input type="text" name="minimum_order10" id="minimum_order10" value="" style="width:120px; " /></td>
