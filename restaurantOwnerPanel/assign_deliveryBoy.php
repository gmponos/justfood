				...
				<div class="container-fluid">
					...
					<div class="tabbable main-tabs">
						...
						<ul class="nav nav-tabs">
							...
							<li class="active" ><a href="#mainFormElements"  data-toggle="tab" style="color:#FFFFFF;"><i class="icon-file"></i>Assign Order to <?php echo ucwords($CuisineData1['restaurant_name']);?> Delivery Boy</a></li>
