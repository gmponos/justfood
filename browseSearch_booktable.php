...
<div class="codepost">
<input type="hidden" name="BookaTableOrdersupport" value="1">
        ...
        <div class="codepost">
          ...
          <input type="text" name="restaurantCity" id="restaurantCity1" class="boxtxt" placeholder="Type location name" />
        </div>
        <div class="codepost">
