...
$ReviewQuery="INSERT INTO `tbl_restaurantReview` (`id`, `RestaurantReviewId`, `RestaurantReviewName`, `RestaurantReviewUName`, `RestaurantReviewEmail`, `RestaurantReviewContent`, `RestaurantReviewRating`, `ratingTotalNumber`, `Quality_ratingN`, `TotalQuality_ratingN`, `Service_ratingN`, `TotalService_ratingN`, `Time_ratingN`, `TotalTime_ratingN`, `status`, `created_date`, `ip_address`, `userLoginID`, `ipblock`, `Restaurant_orderID`) VALUES (NULL, '".$_GET['hotel_id']."', N'".$resdata['restaurant_name']."', N'$FullName', '".$udata['user_email']."', N'$RestaurantReviewContent', '$RestaurantReviewRating', '$RestaurantReviewRating', '$Quality_ratingN','$Quality_ratingN', '$Service_ratingN','$Service_ratingN', '$Time_ratingN', '$Time_ratingN','0', '$today', '$ip', '".$_SESSION['justfoodsUserID']."', '0', '".$_GET['orderid']."')";
mysql_query($ReviewQuery);
mysql_query("update tbl_restaurantAdd set rating='".$RestaurantReviewRating."' where id='".$_GET['hotel_id']."'");
$msg=1;
}
...
<div class="add-to-cart">
  ...
  <h2>Write Rating with Comment for <?php echo ucwords($resdata['restaurant_name']); ?>  <a href="order_review.php" target="_parent"  style="float:right;"><img src="images/popupclose.png" /></a></h2>
  
  <?php 
		  if($msg!=''){
		  ?>
          <div style="color:#008000; font-size:18px; font-weight:bold; padding:7px;">Thankyou for giving Rating & Review</div>
          <?php } ?>
...
<form id="SignupForm" action="" method="post">
  ...
  <tr>
    ...
    <td><textarea id="RestaurantReviewContent"  name="RestaurantReviewContent"  style="width:300px; height:100px;"><?php echo $CuisineData['RestaurantReviewContent']; ?></textarea>
    
    </td>
  </tr>
 
    <tr><td colspan="2" align="center">	 
<input type="submit" class="btn btn-inverse" name="addReviewandRating"  value="Write Review & Rating" style="margin-left:236px;" >
</td></tr>
