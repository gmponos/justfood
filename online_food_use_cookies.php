...
$AboutData=mysql_fetch_assoc(mysql_query("select * from tbl_HowUseCookie"));
...
<title itemprop="description"><?php echo stripslashes(ucwords($AboutData['content_TitleMeta'])); ?>  | Cookies | </title>
...
<div class="login">
  ...
  <h2 style="margin-bottom:10px;color:#E51B24;"><font><font>How we use Cookies 
