...
$menuCheesTitle=mysql_fetch_assoc(mysql_query("select * from tbl_restaurantMainMenuItemPizzaChees where menuitemID='".$_GET['menuID']."' and SizeRestaurantPizzaID='".$_GET['restaurantID']."' "));
 ...
 // Already Checked 
  ...
  $plwwkAlready=mysql_query("select * from tbl_restaurantMainMenuItemPizzaExtraitem where menuExtraChecked ='1' and menuitemID='".$_GET['menuID']."'");
 $AlreadySelct22='';
 $ExtraitemID='';
 ...
 $plwwkAlready22=mysql_query("select * from tbl_restaurantMainMenuItemPizzaExtraitemGroup where menuExtraChecked ='1' and menuitemID='".$_GET['menuID']."'");
 $AlreadySelct232='';
 $ExtraitemGroupID='';
 ...
 if(mysql_num_rows($pl)>0)
 {
  ...
  else
  {
   ...
   $plwwk=mysql_query("select * from tbl_restaurantMainMenuItemPizzaExtraitem where menuExtraCheckedSelection !='0' and menuitemID='".$_GET['menuID']."'");
 $Selct2='';
 $ExtraitemID='';
 ...
 if(mysql_num_rows($pl)>0)
 {
  ...
  {
   mysql_query("update tbl_restaurantMainMenuItemPizzaExtraitemGroup set menuExtraCheckedSelection='".$_GET['selectiona']."' where id='".$_GET['checkboxid']."' ");
  }
...
$plk=mysql_query("select * from tbl_restaurantMainMenuItemPizzaExtraitemGroup where menuExtraCheckedSelection !='0' and menuitemID='".$_GET['menuID']."'");
...
<h2><?php echo $MainMenuSingleData['RestaurantPizzaItemName']; ?>
 ...
 <span id="PriceChange" style="float:right;">&euro; <?php 
if($totalValu!=''){
...
<img src="control/MenuItemImg/MenuItemImgSmall/<?php echo $MainMenuSingleData['ResPizzaImg'];?>" width="50" height="40" />
<?php } ?>
<p style="margin-left:100px; margin-top:-36px; position:absolute;"><?php echo $MainMenuSingleData['restaurantMenuNameDescription'];?></p>
<div class="cart_main">
...
<table width="99%">
  <tr>
    <td valign="top" width="10%"><input id="<?php echo $count;?>" required type="radio" <?php if($_GET['size']==$MainMenuSizeData['id']){ ?> checked="checked" <?php } ?> name="MenuSize" onclick="loadXMLDoc('<?php echo $MainMenuSizeData['id']?>','<?php echo $_GET['menuID'];?>','<?php echo $_GET['restaurantID'];?>')" value="<?php echo $MainMenuSizeData['id']?>"></td>
...
<table width="99%">
  <tr>
    <td valign="top" width="10%"><input id="<?php echo $i;?>" required type="radio" <?php if($_GET['base']==$MainMenuOPtion1Data['id']){ ?> checked="checked" <?php } ?> onclick="getBaseValueAjax('<?php echo $MainMenuOPtion1Data['id']?>','<?php echo $_GET['menuID'];?>','<?php echo $_GET['restaurantID'];?>','<?php echo $_GET['size'];?>','<?php echo $_GET['dough'];?>')"   name="baseValue"  value="<?php echo $MainMenuOPtion1Data['id']?>"></td>
...
<table width="99%">
  <tr>
    <td valign="top" width="10%"><input id="<?php echo $i;?>" type="radio"  disabled="disabled" onclick="getBaseValueAjax('<?php echo $BaseDisableData['id']?>','<?php echo $_GET['menuID'];?>','<?php echo $_GET['restaurantID'];?>','<?php echo $_GET['size'];?>','<?php echo $_GET['dough'];?>')"   name="baseValue1"  value="<?php echo $MainMenuOPtion1Data['id']?>"></td>
...
<!---------------------------Select end Start Here---------------------------------------->   
 ...
 if(mysql_num_rows($ploChees)>0){
  ...
  <tr>
    ...
    <?php } else { ?>
     <p>Select Chees <span>(*mandatory field)</span></p>
     <?php } ?>
<div class="rowcontent" style="background:#f7f9f9;">
<?php 
...
<table width="99%">
  <tr>
    <td valign="top" width="10%"><input id="<?php echo $i;?>" type="radio" required name="cheesValue" <?php if($_GET['chees']==$MainMenuOPtion1Data['id']){ ?> checked="checked" <?php } ?>  onclick="getCheesValueAjax('<?php echo $MainMenuOPtion1Data['id']?>','<?php echo $_GET['menuID'];?>','<?php echo $_GET['restaurantID'];?>','<?php echo $_GET['size'];?>','<?php echo $_GET['dough'];?>','<?php echo $_GET['base'];?>')" value="<?php echo $MainMenuOPtion1Data['id']?>"></td>
...
<table width="99%">
  <tr>
    <td valign="top" width="10%"><input id="<?php echo $i;?>" type="radio" name="cheesValue1"  disabled="disabled"  onclick="getCheesValueAjax('<?php echo $DisableCheesData['id']?>','<?php echo $_GET['menuID'];?>','<?php echo $_GET['restaurantID'];?>','<?php echo $_GET['size'];?>','<?php echo $_GET['dough'];?>','<?php echo $_GET['base'];?>')" value="<?php echo $DisableCheesData['id']?>"></td>
...
<div class="rowcontent" style="height:80px; width:103%; overflow-y: scroll; background:#f7f9f9;">
<div class="radio">
 ...
 <div style="float:left; width:100%; min-height:20px; padding-bottom:2px;">
       <?php if($ExtraMainMenuOPtion1DataGroup['menuExtraQuantity']==1 || $ExtraMainMenuOPtion1DataGroup['menuExtraQuantity']=='' ){?>
        ...
        <?php if($ExtraMainMenuOPtion1Data['menuExtraChecked']==1){ ?>
          ...
          <?php } else { ?>
           <input style="width:10px; height:10px;" type="checkbox" <?php if($ExtraMainMenuOPtion1DataGroup['menuExtraCheckedSelection']==1){ ?>  checked="checked" <?php }?> <?php if($kmop1>=3){ ?> onclick="alert('Sorry ! You have selected max number of data')" <?php } else { ?> onclick="getExtarValueAjax1('<?php echo $ExtraMainMenuOPtion1DataGroup['id']?>','<?php echo $_GET['menuID'];?>','<?php echo $_GET['restaurantID'];?>','<?php echo $_GET['size'];?>','<?php echo $_GET['dough'];?>','<?php echo $_GET['base'];?>','<?php echo $_GET['chees'];?>','1','1')" <?php } ?> />
          <?php } ?>
        </div>
      </div>
	...
	?> &euro;</td>
      ...
      <div style="width:11%; min-height:30px; float:left;">
        ...
        <?php if($ExtraMainMenuOPtion1Data['menuExtraChecked']==1){ ?>
          <input type="checkbox"  checked="checked"  disabled="disabled" />
          <?php } else { ?>
          <input type="checkbox" <?php if($ExtraMainMenuOPtion1DataGroup['menuExtraCheckedSelection']==2){ ?> checked="checked" <?php }?> <?php if($kmop1>=3){ ?> onclick="alert('Sorry ! You have selected max number of data')"<?php } else { ?> onclick="getExtarValueAjax1('<?php echo $ExtraMainMenuOPtion1DataGroup['id']?>','<?php echo $_GET['menuID'];?>','<?php echo $_GET['restaurantID'];?>','<?php echo $_GET['size'];?>','<?php echo $_GET['dough'];?>','<?php echo $_GET['base'];?>','<?php echo $_GET['chees'];?>','2','2')" <?php } ?> />
          <?php } ?>
        </div>
      </div>
  ...
  ?>
    ...
    <?php if($AjaxExtraMainMenuOPtion1Data['menuExtraQuantity']==1 || $AjaxExtraMainMenuOPtion1Data['menuExtraQuantity']=='' ){?>
        ...
        <?php if($AjaxExtraMainMenuOPtion1Data['menuExtraChecked']==1){ ?>
          <input type="checkbox"  checked="checked" disabled="disabled"  />
          <?php } else { ?>
             <input type="checkbox"  <?php if($AjaxExtraMainMenuOPtion1Data['menuExtraCheckedSelection']==1){ ?> checked="checked" <?php } ?> onclick="getExtarValueAjax('<?php echo $AjaxExtraMainMenuOPtion1Data['id']?>','<?php echo $_GET['menuID'];?>','<?php echo $_GET['restaurantID'];?>','<?php echo $_GET['size'];?>','<?php echo $_GET['dough'];?>','<?php echo $_GET['base'];?>','<?php echo $_GET['chees'];?>','1')" />
          <?php } ?>
        </div>
      </div>
	...
	?> &euro;
      ...
      <div style="width:11%; min-height:15px; float:left;">
        ...
        <?php if($AjaxExtraMainMenuOPtion1Data['menuExtraChecked']==1){ ?>
          <input type="checkbox"  checked="checked" disabled="disabled"  />
          <?php } else { ?>
          <input type="checkbox" <?php if($AjaxExtraMainMenuOPtion1Data['menuExtraCheckedSelection']==2){ ?> checked="checked" <?php } ?> onclick="getExtarValueAjax('<?php echo $AjaxExtraMainMenuOPtion1Data['id']?>','<?php echo $_GET['menuID'];?>','<?php echo $_GET['restaurantID'];?>','<?php echo $_GET['size'];?>','<?php echo $_GET['dough'];?>','<?php echo $_GET['base'];?>','<?php echo $_GET['chees'];?>','2')" />
          <?php } ?>
        </div>
      </div>
 ...
 <tr><td>Quantity</td><td>
   ...
   <tr><td colspan="2">&nbsp;</td></tr>
    <tr><td colspan="2"><textarea style="width:550px; height:70px;" name="SpecialInstruction" placeholder="Special Instructions"></textarea></td></tr>
      ...
      <tr><td colspan="2" align="center"><input type="submit" name="" value="Add to Cart" class="submit" />
</td></tr>
</table>
