...
<div class="cartwrapper">
  <div class="cartheader">
    <h2 style="padding: 2px 1px 1px 10px;">Bids :</h2>
  </div>
  <div class="cartcontainer">
    <div class="cartcontent" id="myDiv">
      <div>
        ...
        <p style="font-size:12px; color:#CCCCCC;"><?php echo ucwords($OnlineOfferData1['ResPizzaDescription']); ?></p>
        <div class="cart_main">
...
<?php /*?><input type="hidden" name="item_offerInsert" value="1"  />
...
?>
              <tr>
                ...
                <td><div id="dd<?php echo $i;?>" class="wrapper-dropdown-3" tabindex="1"> <span>
				<?php if($_GET['FoodOfferName']!=''){ ?>
				<?php echo $_GET['FoodOfferName'];
				} else { ?>
					<?php echo $dealsData['offerSlotTitle'];?>
                <?php } ?>
  ...
  $i++;
              ...
              <tr>
                <td colspan="2" align="center"><input type="submit" name="" value="Add to Bids" class="submit" />
                  <br />
                  <a href="restaurant.php?restaurants=<?php echo urlencode(trim($_GET['restaurants'])); ?>" target="_parent">Cancellation Offer</a>
            </table>
          </form>
        </div>
      </div>
