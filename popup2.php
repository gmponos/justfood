...
if($_GET['menuofferID']!='')
{
$_SESSION['menuofferID']=$_GET['menuofferID'];
}
if($_GET['restaurants']!='')
{
...
.cartheader{width:100%; height:36px; border-bottom:1px solid #ccc; background:#f25804; color:#FFFFFF;border-radius: 5px 5px 0 0; margin-bottom:7px;margin-top:19px;
}
.cartcontent{}
...
.cartcontainer .third{width:33%; min-height:25px;float:left;}
.cartcontainer .left{width:75%;  float:left; text-align:left; margin-left:-5px;}
...
function loadXMLDoc(str,mainmenuId,restaurantId,PriceBalance)
{
 var PriceBalance1= document.getElementById("quantity").value;
    ...
    xmlhttp.open("GET","ajaxData2.php?size="+str+"&menuID="+mainmenuId+"&restaurantID="+restaurantId+"&PriceBalance="+PriceBalance1,true);
    xmlhttp.send();
}
function getdoughValueAjax(str,mainmenuId,restaurantId,menusizeID,PriceBalance)
{
 var PriceBalance1= document.getElementById("quantity").value;
    ...
    xmlhttp.open("GET","ajaxData2.php?dough="+str+"&menuID="+mainmenuId+"&restaurantID="+restaurantId+"&size="+menusizeID+"&PriceBalance="+PriceBalance1,true);
    xmlhttp.send();
}
...
function getBaseValueAjax(str,mainmenuId,restaurantId,menusizeID,menudoughID,PriceBalance)
{
 var PriceBalance1= document.getElementById("quantity").value;
    ...
    xmlhttp.open("GET","ajaxData2.php?base="+str+"&menuID="+mainmenuId+"&restaurantID="+restaurantId+"&size="+menusizeID+"&dough="+menudoughID+"&PriceBalance="+PriceBalance1,true);
    xmlhttp.send();
}
...
function getCheesValueAjax(str,mainmenuId,restaurantId,menusizeID,menudoughID,menubaseID,PriceBalance)
{
 var PriceBalance1= document.getElementById("quantity").value;
    ...
    xmlhttp.open("GET","ajaxData2.php?chees="+str+"&menuID="+mainmenuId+"&restaurantID="+restaurantId+"&size="+menusizeID+"&dough="+menudoughID+"&base="+menubaseID+"&PriceBalance="+PriceBalance1,true);
    xmlhttp.send();
}
...
//alert(numb);
 var PriceBalance1= document.getElementById("quantity").value;
    ...
    xmlhttp.open("GET","ajaxData2.php?checkboxid="+str+"&menuID="+mainmenuId+"&restaurantID="+restaurantId+"&size="+menusizeID+"&dough="+menudoughID+"&base="+menubaseID+"&chees="+menucheesID+"&numValue="+numb+"&PriceBalance="+PriceBalance1,true);
    xmlhttp.send();
}
...
//alert(selection);
 var PriceBalance1= document.getElementById("quantity").value;
    ...
    xmlhttp.open("GET","ajaxData2.php?checkboxid1="+str+"&menuID="+mainmenuId+"&restaurantID="+restaurantId+"&size="+menusizeID+"&dough="+menudoughID+"&base="+menubaseID+"&chees="+menucheesID+"&numValue1="+numb+"&selectiona="+selection+"&PriceBalance="+PriceBalance1,true);
    xmlhttp.send();
}
...
//alert(selection);
    ...
    xmlhttp.open("GET","ajaxData2.php?PriceBalance="+str+"&menuID="+mainmenuId+"&restaurantID="+restaurantId+"&size="+menusizeID+"&dough="+menudoughID+"&base="+menubaseID+"&chees="+menucheesID+"&checkboxid="+checkboxid1+"&checkboxid1="+checkboxid11,true);
    xmlhttp.send();
}
...
<table width="100%">
  <tr>
    <td><h2><?php echo $MainMenuSingleData['RestaurantPizzaItemName']; ?> <span id="PriceChange" style="float:right;"><?php echo $AdminDataLoginVal['website_CurrencySymbole']; ?> <?php 
								if($MainMenuSingleData['MenuSlotPrice']!=''){
echo number_format($MainMenuSingleData['MenuSlotPrice'],2);
}
else
{
...
<?php } ?></td>
  ...
  <form class="addtc" id="myform" action="onlineBids.php?RestaurantPizzaID=<?php echo $_GET['RestaurantPizzaID']; ?>&menuofferID=<?php echo $_GET['menuofferID'];?>&restaurants=<?php echo $_GET['restaurants'];?>" target="_parent"  method="post">
