...
<link href="tables/tab.css" rel="stylesheet" type="text/css" /> 
 <link href="tables/jquery-ui.css" rel="stylesheet" type="text/css" media="all" />
...
<div id="tabs">
  <ul>
    <li><a href="#tabs-11">Cash on delivery</a></li>
    <li><a href="#tabs-12">Credit Card</a></li>
    <li><a href="#tabs-13">Debit Card</a></li>
    <li><a href="#tabs-14">Pay by Paypal</a></li>
  </ul>
  <div id="tabs-11">
    <h1 style="color:#D80E0F; font-size:20px; border-bottom:1px solid #CCC; margin-bottom:20px; padding-bottom:3px;">Cash on Delivery</h1>
    <p style="float:left; margin-right:10px;">Amount Payable on delivery: </p><h1 style="color:#D80E0F; font-size:18px; font-weight:bold;">&euro; 10</h1>
  </div>
  <div id="tabs-12">
  <p>
    <h1 style="color:#D80E0F; font-size:20px; border-bottom:1px solid #CCC; margin-bottom:20px; padding-bottom:3px; float:left;">Pay using Credit Card</h1><h4 style="margin-bottom:5px;">(International Cards are supported)</h4></p>
  <!-- <p>Please, provide the following details</p>-->
   <table width="90%" style="margin-bottom:25px;">
   <tr>
   <td width="25%">Card Number<span>*</span></td>
   <td width="75%"><input type="text" name="" id="" class="txt_box" maxlength="50" /></td>
   </tr>
    <tr>
   <td width="25%">Expiry Date (Valid Thru)<span>*</span></td>
   <td width="75%"><input type="text" name="" id="" class="txt_box" maxlength="50" /></td>
   </tr>
    <tr>
   <td width="25%">CVV Number<span>*</span></td>
   <td width="75%"><input type="text" name="" id="" class="txt_box" maxlength="50" /></td>
   </tr>
   <tr>
   <td width="25%">Name on card<span>*</span></td>
   <td width="75%"><input type="text" name="" id="" class="txt_box" /></td>
   </tr>
   
   <tr>
   <td width="25%"></td>
   <td width="75%"><input type="submit" name="" value="Pay" class="submit" /></td>
   </tr>
  ...
  <div id="tabs-13">
   <p>
    <h1 style="color:#D80E0F; font-size:20px; border-bottom:1px solid #CCC; margin-bottom:20px; padding-bottom:3px; float:left;">Pay using Debit Card</h1><h4 style="margin-bottom:5px;">(International Cards are supported)</h4></p>
  <!-- <p>Please, provide the following details</p>-->
   <table width="90%" style="margin-bottom:25px;">
   <tr>
   <td width="25%">Card Number<span>*</span></td>
  ...
  <div id="tabs-14">
   <h1 style="color:#D80E0F; font-size:20px; border-bottom:1px solid #CCC; margin-bottom:20px; padding-bottom:3px;">Pay by Paypal</h1>
   <p>Log in to your Paypal account to complete the purchase.</p>
   <table width="90%" style="margin-bottom:25px;">
   <tr>
   <td width="25%">Paypal Id<span>*</span></td>
   <td width="75%"><input type="text" name="" id="" class="txt_box" maxlength="50" /></td>
   </tr>
   
   <tr>
   <td width="25%">Paypal Passwrd<span>*</span></td>
   <td width="75%"><input type="password" name="" id="" class="txt_box" /></td>
   </tr>
   
   <tr>
   <td width="25%"></td>
   <td width="75%"><input type="submit" name="" value="Login" class="submit" /></td>
   </tr>
    <tr>
   <td width="25%"></td>
   <td width="75%"></td>
   ...
   <a href="#">Forgotten your Paypal Id or Paypal Passwrd</a>
  </div>
</div>
