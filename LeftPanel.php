  ...
  ?>
      ...
      <div class="contentleft">
        ...
        <div class="radio">
          ...
          <label for="1">
          <p class="left_p_ml5"><?php echo $AdminDataLoginVal['website_CurrencySymbole'];?> 0.0-5.00</p>
          </label>
          <br />
          ...
          <label for="2">
          <p class="left_p_ml5"><?php echo $AdminDataLoginVal['website_CurrencySymbole'];?> 5.00-10.00</p>
          </label>
          ...
          <label for="3">
          <p class="left_p_ml5"><?php echo $TableLanguage2['MoreThan']; ?> <?php echo $AdminDataLoginVal['website_CurrencySymbole'];?> 10.00</p>
          </label>
          <br />
      ...
      <div class="contentleft">
        ...
        <?php
		$i=12;
		$ServIQuery=mysql_query("select * from tbl_restaurantService where status='0' order by restaurant_service_name asc");
		while($SrvData=mysql_fetch_assoc($ServIQuery)){
		if($_GET['RestaurantService']==$SrvData['restaurant_service_name'])
		{
		$urCod="";
		}
		else
		{
		$urCod="&RestaurantService=".$SrvData['restaurant_service_name'];
		}
		 ?>
       
        <input id="<?php echo $i;?>" type="checkbox" name="RestaurantService" onclick="window.location.href='restaurantSearchText.php?q=0<?php echo $urCod;?><?php echo $restaurant_cuisineUrl;?><?php echo $ratingUrl;?><?php echo $deliveryUrl;?><?php echo $restaurantStateUrl;?><?php echo $restaurantCityUrl;?><?php echo $RestaurantDealsUrl;?><?php echo $AddressSearchUrl;?><?php echo $BookaTableOrdersupportUrl;?><?php echo $RestaurantPostcodeUrl;?>'" value="<?php echo $SrvData['restaurant_service_name'];?>" <?php if($_GET['RestaurantService']==$SrvData['restaurant_service_name']){ ?> checked="checked" <?php } ?> >
		<label for="<?php echo $i;?>">
        <p class="left_p_ml5"><?php echo $SrvData['restaurant_service_name']; ?></p>
        </small>
        </label>
		<?php 
		$i++;
        ...
        <p class="left_p_ml5" style="padding:11px;"><a href="restaurantSearchText.php?q=0" class="btndeals" style="text-align:center; padding:3px 6px;">Clear all Filter</a></p>
      </div>
